...
public class RealmsLongConfirmationScreen extends RealmsScreen {
	...
	public void render(int i, int j, float f) {
		...
		this.drawCenteredString(this.line2, this.width() / 2, class_4359.method_21072(4), 16777215);
		this.drawCenteredString(this.line3, this.width() / 2, class_4359.method_21072(6), 16777215);
		super.render(i, j, f);
	}
