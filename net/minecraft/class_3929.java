...
public class class_3929 extends class_3945<class_3935> {
	public <C extends class_3845> boolean method_17536(
		...
		for (int i = 0; i < arg.field_19316; i++) {
			...
			arg2.method_17343(iWorld, chunkGenerator, random, iWorld.method_16373(class_3804.class_3805.MOTION_BLOCKING, blockPos.add(j, 0, k)), arg3);
		}
