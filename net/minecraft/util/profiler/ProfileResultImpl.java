...
public class ProfileResultImpl implements ProfileResult {
	...
	public List<ProfilerTiming> getTimings(String string) {
		...
		Set<String> set = Sets.newHashSet(this.timings.keySet());
		...
		for (String string6 : this.timings.keySet()) {
			this.timings.put(string6, (Long)this.timings.get(string6) * 999L / 1000L);
		}
