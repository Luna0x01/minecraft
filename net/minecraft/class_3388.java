...
public class class_3388 extends DataFix {
	private static final Map<String, String> field_16555 = (Map<String, String>)DataFixUtils.make(Maps.newHashMap(), hashMap -> {
	...
	public class_3388(Schema schema, boolean bl) {
		super(schema, bl);
	}
		...
		return this.fixTypeEverywhereTyped("ItemInstanceSpawnEggFix", type, typed -> {
			...
			if (optional.isPresent() && Objects.equals(((Pair)optional.get()).getSecond(), "minecraft:spawn_egg")) {
				...
				if (optional2.isPresent()) {
					return typed.set(opticFinder, Pair.of(class_3402.field_16598.typeName(), field_16555.getOrDefault(optional2.get(), "minecraft:pig_spawn_egg")));
				}
			}
