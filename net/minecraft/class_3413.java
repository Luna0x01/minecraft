...
public class class_3413 extends class_3395 {
	public class_3413(Schema schema, boolean bl) {
		super(schema, bl, "Villager trade fix", class_3402.field_16596, "minecraft:villager");
	}
	...
	protected Typed<?> method_15200(Typed<?> typed) {
		...
		if (!(type instanceof ListType)) {
			...
			OpticFinder<Pair<String, String>> opticFinder7 = DSL.fieldFinder("id", DSL.named(class_3402.field_16598.typeName(), DSL.namespacedString()));
			Function<Typed<?>, Typed<?>> function = typedx -> this.method_15281(opticFinder7, typedx);
	...
	private Typed<?> method_15281(OpticFinder<Pair<String, String>> opticFinder, Typed<?> typed) {
