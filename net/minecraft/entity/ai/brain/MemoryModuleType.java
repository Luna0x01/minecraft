...
public class MemoryModuleType<U> {
	...
	public static final MemoryModuleType<VillagerEntity> field_18448 = register("breed_target");
	...
	public static final MemoryModuleType<Set<GlobalPos>> field_20312 = register("opened_doors");
	...
	public static final MemoryModuleType<Long> field_19355 = register("golem_last_seen_time");
	public static final MemoryModuleType<Timestamp> field_19385 = register("last_slept", Optional.of(Timestamp::of));
	public static final MemoryModuleType<Timestamp> field_20616 = register("last_woken", Optional.of(Timestamp::of));
	...
	public String toString() {
		return Registry.field_18793.getId(this).toString();
	}
	...
	private static <U extends DynamicSerializable> MemoryModuleType<U> register(String string, Optional<Function<Dynamic<?>, U>> optional) {
		return Registry.register(Registry.field_18793, new Identifier(string), new MemoryModuleType<>(optional));
	}

	private static <U> MemoryModuleType<U> register(String string) {
		return Registry.register(Registry.field_18793, new Identifier(string), new MemoryModuleType<>(Optional.empty()));
	}
}
