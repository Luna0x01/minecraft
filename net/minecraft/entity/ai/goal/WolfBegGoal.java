...
public class WolfBegGoal extends Goal {
	...
	public boolean canStart() {
		this.begFrom = this.field_16841.method_16364(this.wolf, (double)this.begDistance);
