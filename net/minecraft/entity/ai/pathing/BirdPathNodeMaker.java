...
public class BirdPathNodeMaker extends LandPathNodeMaker {
	...
	public int getPathNodes(PathNode[] pathNodes, PathNode pathNode) {
		...
		if (bl && bl3) {
			...
			if (pathNode9 != null && !pathNode9.field_42) {
		...
		if (bl2 && bl4) {
			...
			if (pathNode10 != null && !pathNode10.field_42) {
		...
		if (bl2 && bl3) {
			...
			if (pathNode11 != null && !pathNode11.field_42) {
				pathNodes[i++] = pathNode11;
			}
		}

		if (bl && bl5) {
			PathNode pathNode12 = this.getPathNode(pathNode.x, pathNode.y + 1, pathNode.z - 1);
			if (pathNode12 != null && !pathNode12.field_42) {
				pathNodes[i++] = pathNode12;
			}
		}

		if (bl2 && bl5) {
			PathNode pathNode13 = this.getPathNode(pathNode.x, pathNode.y + 1, pathNode.z + 1);
			if (pathNode13 != null && !pathNode13.field_42) {
				pathNodes[i++] = pathNode13;
			}
		}

		if (bl3 && bl5) {
			PathNode pathNode14 = this.getPathNode(pathNode.x + 1, pathNode.y + 1, pathNode.z);
			if (pathNode14 != null && !pathNode14.field_42) {
				pathNodes[i++] = pathNode14;
			}
		}

		if (bl4 && bl5) {
			PathNode pathNode15 = this.getPathNode(pathNode.x - 1, pathNode.y + 1, pathNode.z);
			if (pathNode15 != null && !pathNode15.field_42) {
				pathNodes[i++] = pathNode15;
			}
		}

		if (bl && bl6) {
			PathNode pathNode16 = this.getPathNode(pathNode.x, pathNode.y - 1, pathNode.z - 1);
			if (pathNode16 != null && !pathNode16.field_42) {
				pathNodes[i++] = pathNode16;
			}
		}

		if (bl2 && bl6) {
			PathNode pathNode17 = this.getPathNode(pathNode.x, pathNode.y - 1, pathNode.z + 1);
			if (pathNode17 != null && !pathNode17.field_42) {
				pathNodes[i++] = pathNode17;
			}
		}

		if (bl3 && bl6) {
			PathNode pathNode18 = this.getPathNode(pathNode.x + 1, pathNode.y - 1, pathNode.z);
			if (pathNode18 != null && !pathNode18.field_42) {
				pathNodes[i++] = pathNode18;
			}
		}

		if (bl4 && bl6) {
			PathNode pathNode19 = this.getPathNode(pathNode.x - 1, pathNode.y - 1, pathNode.z);
			if (pathNode19 != null && !pathNode19.field_42) {
