...
public class LandPathNodeMaker extends PathNodeMaker {
	...
	public PathNode getStart() {
		...
		PathNodeType pathNodeType = this.getPathNodeType(this.entity, blockPos2.getX(), i, blockPos2.getZ());
		if (this.entity.getPathNodeTypeWeight(pathNodeType) < 0.0F) {
			...
			for (BlockPos blockPos3 : set) {
				PathNodeType pathNodeType2 = this.getPathNodeType(this.entity, blockPos3);
		...
		return this.getPathNode(blockPos2.getX(), i, blockPos2.getZ());
	}
				...
				if (pathNodeType == PathNodeType.field_7) {
					...
					while (pathNodeType == PathNodeType.field_7) {
						...
						if (pathNodeType != PathNodeType.field_7 && f >= 0.0F) {
							...
							pathNode3.field_43 = Math.max(pathNode3.field_43, f);
							break;
						}
