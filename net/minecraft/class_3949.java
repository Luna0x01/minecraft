...
public class class_3949 extends class_3945<class_3948> {
	public <C extends class_3845> boolean method_17536(
		...
		if (random.nextInt(arg.field_19331 / 10) == 0) {
			int i = random.nextInt(16);
			int j = random.nextInt(random.nextInt(chunkGenerator.method_17026() - 8) + 8);
			int k = random.nextInt(16);
			if (j < iWorld.method_8483() || random.nextInt(arg.field_19331 / 8) == 0) {
