...
public class OceanMonumentGenerator {
	public static class Base extends OceanMonumentGenerator.class_3384 {
		...
		private final List<OceanMonumentGenerator.class_3384> field_14465 = Lists.newArrayList();
		...
		public boolean generate(IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox, ChunkPos chunkPos) {
			...
			for (int p = 0; p < 5; p++) {
				this.method_14773(iWorld, mutableIntBoundingBox, -1 - p, 0 + p * 2, -1 - p, -1 - p, 23, 58 + p);
				this.method_14773(iWorld, mutableIntBoundingBox, 58 + p, 0 + p * 2, -1 - p, 58 + p, 23, 58 + p);
				this.method_14773(iWorld, mutableIntBoundingBox, 0 - p, 0 + p * 2, -1 - p, 57 + p, 23, -1 - p);
				this.method_14773(iWorld, mutableIntBoundingBox, 0 - p, 0 + p * 2, 58 + p, 57 + p, 23, 58 + p);
			}
		...
		private void method_14761(boolean bl, int i, IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox) {
			...
			if (this.method_14775(mutableIntBoundingBox, i, 0, i + 23, 20)) {
				...
				for (int n = 20; n >= 5; n -= 3) {
					this.addBlock(iWorld, field_14470, l, 5, n, mutableIntBoundingBox);
				}

				for (int o = 19; o >= 7; o -= 3) {
					this.addBlock(iWorld, field_14470, m, 5, o, mutableIntBoundingBox);
				}

				for (int p = 0; p < 4; p++) {
					int q = bl ? i + 24 - (17 - p * 3) : i + 17 - p * 3;
					this.addBlock(iWorld, field_14470, q, 5, 5, mutableIntBoundingBox);
				}

				this.addBlock(iWorld, field_14470, m, 5, 5, mutableIntBoundingBox);
		...
		private void method_14762(IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox) {
			if (this.method_14775(mutableIntBoundingBox, 15, 20, 42, 21)) {
				...
				for (int j = 0; j < 4; j++) {
					this.addBlock(iWorld, DARK_PRISMARINE, 28 - j, 9 + j, 21, mutableIntBoundingBox);
					this.addBlock(iWorld, DARK_PRISMARINE, 29 + j, 9 + j, 21, mutableIntBoundingBox);
				}
				...
				for (int k = 0; k < 3; k++) {
					this.addBlock(iWorld, DARK_PRISMARINE, 22 - k * 2, 8, 21, mutableIntBoundingBox);
					this.addBlock(iWorld, DARK_PRISMARINE, 22 - k * 2, 9, 21, mutableIntBoundingBox);
					this.addBlock(iWorld, DARK_PRISMARINE, 35 + k * 2, 8, 21, mutableIntBoundingBox);
					this.addBlock(iWorld, DARK_PRISMARINE, 35 + k * 2, 9, 21, mutableIntBoundingBox);
				}
		...
		private void method_14764(IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox) {
			if (this.method_14775(mutableIntBoundingBox, 0, 21, 6, 58)) {
				...
				for (int j = 23; j < 53; j += 3) {
					this.addBlock(iWorld, field_14470, 5, 5, j, mutableIntBoundingBox);
				}

				this.addBlock(iWorld, field_14470, 5, 5, 52, mutableIntBoundingBox);

				for (int k = 0; k < 4; k++) {
					this.fillWithOutline(iWorld, mutableIntBoundingBox, k, k + 1, 21, k, k + 1, 57 - k, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
				}
			...
			if (this.method_14775(mutableIntBoundingBox, 51, 21, 58, 58)) {
				...
				for (int l = 0; l < 4; l++) {
					this.fillWithOutline(iWorld, mutableIntBoundingBox, 57 - l, l + 1, 21, 57 - l, l + 1, 57 - l, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
				}

				for (int m = 23; m < 53; m += 3) {
					this.addBlock(iWorld, field_14470, 52, 5, m, mutableIntBoundingBox);
				}
			...
			if (this.method_14775(mutableIntBoundingBox, 0, 51, 57, 57)) {
				...
				for (int n = 0; n < 4; n++) {
					this.fillWithOutline(iWorld, mutableIntBoundingBox, n + 1, n + 1, 57 - n, 56 - n, n + 1, 57 - n, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
				}
			}
		}
		...
		private void method_14766(IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox) {
			if (this.method_14775(mutableIntBoundingBox, 7, 21, 13, 50)) {
				...
				for (int j = 21; j <= 45; j += 3) {
					this.addBlock(iWorld, field_14470, 12, 9, j, mutableIntBoundingBox);
				}
			}
			...
			if (this.method_14775(mutableIntBoundingBox, 44, 21, 50, 54)) {
				...
				for (int k = 0; k < 4; k++) {
					this.fillWithOutline(iWorld, mutableIntBoundingBox, 50 - k, k + 5, 21, 50 - k, k + 5, 54, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
				}

				for (int l = 21; l <= 45; l += 3) {
					this.addBlock(iWorld, field_14470, 45, 9, l, mutableIntBoundingBox);
				}
			}
			...
			if (this.method_14775(mutableIntBoundingBox, 8, 44, 49, 54)) {
				...
				for (int m = 12; m <= 45; m += 3) {
					this.addBlock(iWorld, field_14470, m, 9, 45, mutableIntBoundingBox);
					this.addBlock(iWorld, field_14470, m, 9, 52, mutableIntBoundingBox);
					if (m == 12 || m == 18 || m == 24 || m == 33 || m == 39 || m == 45) {
						this.addBlock(iWorld, field_14470, m, 9, 47, mutableIntBoundingBox);
						this.addBlock(iWorld, field_14470, m, 9, 50, mutableIntBoundingBox);
						this.addBlock(iWorld, field_14470, m, 10, 45, mutableIntBoundingBox);
						this.addBlock(iWorld, field_14470, m, 10, 46, mutableIntBoundingBox);
						this.addBlock(iWorld, field_14470, m, 10, 51, mutableIntBoundingBox);
						this.addBlock(iWorld, field_14470, m, 10, 52, mutableIntBoundingBox);
						this.addBlock(iWorld, field_14470, m, 11, 47, mutableIntBoundingBox);
						this.addBlock(iWorld, field_14470, m, 11, 50, mutableIntBoundingBox);
						this.addBlock(iWorld, field_14470, m, 12, 48, mutableIntBoundingBox);
						this.addBlock(iWorld, field_14470, m, 12, 49, mutableIntBoundingBox);
					}
				}

				for (int n = 0; n < 3; n++) {
					this.fillWithOutline(iWorld, mutableIntBoundingBox, 8 + n, 5 + n, 54, 49 - n, 5 + n, 54, PRISMARINE, PRISMARINE, false);
				}
		...
		private void method_14767(IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox) {
			if (this.method_14775(mutableIntBoundingBox, 14, 21, 20, 43)) {
				...
				for (int j = 23; j <= 39; j += 3) {
					this.addBlock(iWorld, field_14470, 19, 13, j, mutableIntBoundingBox);
				}
			}
			...
			if (this.method_14775(mutableIntBoundingBox, 37, 21, 43, 43)) {
				...
				for (int k = 0; k < 4; k++) {
					this.fillWithOutline(iWorld, mutableIntBoundingBox, 43 - k, k + 9, 21, 43 - k, k + 9, 43 - k, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
				}

				for (int l = 23; l <= 39; l += 3) {
					this.addBlock(iWorld, field_14470, 38, 13, l, mutableIntBoundingBox);
				}
			}
			...
			if (this.method_14775(mutableIntBoundingBox, 15, 37, 42, 43)) {
				...
				for (int m = 0; m < 4; m++) {
					this.fillWithOutline(iWorld, mutableIntBoundingBox, 15 + m, m + 9, 43 - m, 42 - m, m + 9, 43 - m, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
				}

				for (int n = 21; n <= 36; n += 3) {
					this.addBlock(iWorld, field_14470, n, 13, 38, mutableIntBoundingBox);
				}
			}
		}
	}
		...
		public boolean generate(IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox, ChunkPos chunkPos) {
			...
			for (int j = 1; j <= 6; j++) {
				...
				for (int k = 0; k <= 15; k += 15) {
					this.fillWithOutline(iWorld, mutableIntBoundingBox, k, j, 0, k, j, 1, blockState, blockState, false);
					this.fillWithOutline(iWorld, mutableIntBoundingBox, k, j, 6, k, j, 9, blockState, blockState, false);
					this.fillWithOutline(iWorld, mutableIntBoundingBox, k, j, 14, k, j, 15, blockState, blockState, false);
				}

				this.fillWithOutline(iWorld, mutableIntBoundingBox, 1, j, 0, 1, j, 0, blockState, blockState, false);
				this.fillWithOutline(iWorld, mutableIntBoundingBox, 6, j, 0, 9, j, 0, blockState, blockState, false);
				this.fillWithOutline(iWorld, mutableIntBoundingBox, 14, j, 0, 14, j, 0, blockState, blockState, false);
				this.fillWithOutline(iWorld, mutableIntBoundingBox, 1, j, 15, 14, j, 15, blockState, blockState, false);
			}
			...
			for (int l = 3; l <= 6; l += 3) {
				for (int m = 6; m <= 9; m += 3) {
					this.addBlock(iWorld, SEA_LANTERN, m, l, 6, mutableIntBoundingBox);
					this.addBlock(iWorld, SEA_LANTERN, m, l, 9, mutableIntBoundingBox);
				}
			}
	...
	public static class DoubleYZRoom extends OceanMonumentGenerator.class_3384 {
		...
		public boolean generate(IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox, ChunkPos chunkPos) {
			...
			for (int j = 1; j <= 7; j++) {
				...
				this.fillWithOutline(iWorld, mutableIntBoundingBox, 3, j, 7, 4, j, 8, blockState2, blockState2, false);
			}
	...
	public static class Penthouse extends OceanMonumentGenerator.class_3384 {
		...
		public boolean generate(IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox, ChunkPos chunkPos) {
			...
			for (int k = 0; k < 2; k++) {
				for (int l = 2; l <= 8; l += 3) {
					this.fillWithOutline(iWorld, mutableIntBoundingBox, j, 0, l, j, 2, l, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
				}
		...
		public boolean generate(IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox, ChunkPos chunkPos) {
			if (this.field_14481 == 0) {
				...
				for (int j = 18; j >= 7; j -= 3) {
					this.addBlock(iWorld, SEA_LANTERN, 6, 3, j, mutableIntBoundingBox);
					this.addBlock(iWorld, SEA_LANTERN, 16, 3, j, mutableIntBoundingBox);
				}
				...
				for (int n = 0; n < 2; n++) {
					this.addBlock(iWorld, PRISMARINE_BRICKS, k, 6, 20, mutableIntBoundingBox);
					this.addBlock(iWorld, SEA_LANTERN, k, 5, 20, mutableIntBoundingBox);
					this.addBlock(iWorld, PRISMARINE_BRICKS, k, 4, 20, mutableIntBoundingBox);
					k = 13;
				}
