...
public class OceanMonumentGenerator {
	public static class Base extends OceanMonumentGenerator.Piece {
		...
		public boolean generate(
			...
			for (int p = 0; p < 5; p++) {
				this.setAirAndWater(structureWorldAccess, boundingBox, -1 - p, 0 + p * 2, -1 - p, -1 - p, 23, 58 + p);
				this.setAirAndWater(structureWorldAccess, boundingBox, 58 + p, 0 + p * 2, -1 - p, 58 + p, 23, 58 + p);
				this.setAirAndWater(structureWorldAccess, boundingBox, 0 - p, 0 + p * 2, -1 - p, 57 + p, 23, -1 - p);
				this.setAirAndWater(structureWorldAccess, boundingBox, 0 - p, 0 + p * 2, 58 + p, 57 + p, 23, 58 + p);
			}
		...
		private void method_14761(boolean bl, int i, StructureWorldAccess structureWorldAccess, Random random, BlockBox blockBox) {
			...
			if (this.method_14775(blockBox, i, 0, i + 23, 20)) {
				...
				for (int n = 20; n >= 5; n -= 3) {
					this.addBlock(structureWorldAccess, field_14470, l, 5, n, blockBox);
				}

				for (int o = 19; o >= 7; o -= 3) {
					this.addBlock(structureWorldAccess, field_14470, m, 5, o, blockBox);
				}
		...
		private void method_14762(StructureWorldAccess structureWorldAccess, Random random, BlockBox blockBox) {
			if (this.method_14775(blockBox, 15, 20, 42, 21)) {
				...
				for (int j = 0; j < 4; j++) {
					this.addBlock(structureWorldAccess, DARK_PRISMARINE, 28 - j, 9 + j, 21, blockBox);
					this.addBlock(structureWorldAccess, DARK_PRISMARINE, 29 + j, 9 + j, 21, blockBox);
				}
		...
		private void method_14764(StructureWorldAccess structureWorldAccess, Random random, BlockBox blockBox) {
			if (this.method_14775(blockBox, 0, 21, 6, 58)) {
				...
				for (int j = 23; j < 53; j += 3) {
					this.addBlock(structureWorldAccess, field_14470, 5, 5, j, blockBox);
				}
			...
			if (this.method_14775(blockBox, 51, 21, 58, 58)) {
				...
				for (int l = 0; l < 4; l++) {
					this.fillWithOutline(structureWorldAccess, blockBox, 57 - l, l + 1, 21, 57 - l, l + 1, 57 - l, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
				}

				for (int m = 23; m < 53; m += 3) {
					this.addBlock(structureWorldAccess, field_14470, 52, 5, m, blockBox);
				}
			...
			if (this.method_14775(blockBox, 0, 51, 57, 57)) {
				...
				for (int n = 0; n < 4; n++) {
					this.fillWithOutline(structureWorldAccess, blockBox, n + 1, n + 1, 57 - n, 56 - n, n + 1, 57 - n, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
				}
			}
		}
		...
		private void method_14766(StructureWorldAccess structureWorldAccess, Random random, BlockBox blockBox) {
			if (this.method_14775(blockBox, 7, 21, 13, 50)) {
				...
				for (int j = 21; j <= 45; j += 3) {
					this.addBlock(structureWorldAccess, field_14470, 12, 9, j, blockBox);
				}
			}
			...
			if (this.method_14775(blockBox, 44, 21, 50, 54)) {
				...
				for (int k = 0; k < 4; k++) {
					this.fillWithOutline(structureWorldAccess, blockBox, 50 - k, k + 5, 21, 50 - k, k + 5, 54, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
				}

				for (int l = 21; l <= 45; l += 3) {
					this.addBlock(structureWorldAccess, field_14470, 45, 9, l, blockBox);
				}
			}
			...
			if (this.method_14775(blockBox, 8, 44, 49, 54)) {
				...
				for (int m = 12; m <= 45; m += 3) {
					this.addBlock(structureWorldAccess, field_14470, m, 9, 45, blockBox);
					this.addBlock(structureWorldAccess, field_14470, m, 9, 52, blockBox);
					if (m == 12 || m == 18 || m == 24 || m == 33 || m == 39 || m == 45) {
						this.addBlock(structureWorldAccess, field_14470, m, 9, 47, blockBox);
						this.addBlock(structureWorldAccess, field_14470, m, 9, 50, blockBox);
						this.addBlock(structureWorldAccess, field_14470, m, 10, 45, blockBox);
						this.addBlock(structureWorldAccess, field_14470, m, 10, 46, blockBox);
						this.addBlock(structureWorldAccess, field_14470, m, 10, 51, blockBox);
						this.addBlock(structureWorldAccess, field_14470, m, 10, 52, blockBox);
						this.addBlock(structureWorldAccess, field_14470, m, 11, 47, blockBox);
						this.addBlock(structureWorldAccess, field_14470, m, 11, 50, blockBox);
						this.addBlock(structureWorldAccess, field_14470, m, 12, 48, blockBox);
						this.addBlock(structureWorldAccess, field_14470, m, 12, 49, blockBox);
					}
				}
		...
		private void method_14767(StructureWorldAccess structureWorldAccess, Random random, BlockBox blockBox) {
			if (this.method_14775(blockBox, 14, 21, 20, 43)) {
				...
				for (int j = 23; j <= 39; j += 3) {
					this.addBlock(structureWorldAccess, field_14470, 19, 13, j, blockBox);
				}
			}
			...
			if (this.method_14775(blockBox, 37, 21, 43, 43)) {
				...
				for (int k = 0; k < 4; k++) {
					this.fillWithOutline(structureWorldAccess, blockBox, 43 - k, k + 9, 21, 43 - k, k + 9, 43 - k, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
				}

				for (int l = 23; l <= 39; l += 3) {
					this.addBlock(structureWorldAccess, field_14470, 38, 13, l, blockBox);
				}
			}
			...
			if (this.method_14775(blockBox, 15, 37, 42, 43)) {
				...
				for (int m = 0; m < 4; m++) {
					this.fillWithOutline(structureWorldAccess, blockBox, 15 + m, m + 9, 43 - m, 42 - m, m + 9, 43 - m, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
				}
	...
	public static class CoreRoom extends OceanMonumentGenerator.Piece {
		...
		public boolean generate(
			...
			this.fillWithOutline(structureWorldAccess, boundingBox, 0, 7, 0, 0, 7, 15, blockState, blockState, false);
			this.fillWithOutline(structureWorldAccess, boundingBox, 15, 7, 0, 15, 7, 15, blockState, blockState, false);
			this.fillWithOutline(structureWorldAccess, boundingBox, 1, 7, 0, 15, 7, 0, blockState, blockState, false);
			this.fillWithOutline(structureWorldAccess, boundingBox, 1, 7, 15, 14, 7, 15, blockState, blockState, false);
			...
			for (int j = 1; j <= 6; j++) {
				...
				for (int k = 0; k <= 15; k += 15) {
					this.fillWithOutline(structureWorldAccess, boundingBox, k, j, 0, k, j, 1, blockState, blockState, false);
					this.fillWithOutline(structureWorldAccess, boundingBox, k, j, 6, k, j, 9, blockState, blockState, false);
					this.fillWithOutline(structureWorldAccess, boundingBox, k, j, 14, k, j, 15, blockState, blockState, false);
				}

				this.fillWithOutline(structureWorldAccess, boundingBox, 1, j, 0, 1, j, 0, blockState, blockState, false);
				this.fillWithOutline(structureWorldAccess, boundingBox, 6, j, 0, 9, j, 0, blockState, blockState, false);
				this.fillWithOutline(structureWorldAccess, boundingBox, 14, j, 0, 14, j, 0, blockState, blockState, false);
				this.fillWithOutline(structureWorldAccess, boundingBox, 1, j, 15, 14, j, 15, blockState, blockState, false);
			}
		...
		public boolean generate(
			...
			for (int i = 1; i <= 5; i += 4) {
				...
				if (pieceSetting2.neighborPresences[Direction.NORTH.getId()]) {
					...
					this.fillWithOutline(structureWorldAccess, boundingBox, 0, i, var13, 7, i + 2, var13, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
					this.fillWithOutline(structureWorldAccess, boundingBox, 0, i + 1, var13, 7, i + 1, var13, PRISMARINE, PRISMARINE, false);
				}
				...
				if (pieceSetting2.neighborPresences[Direction.EAST.getId()]) {
					...
					this.fillWithOutline(structureWorldAccess, boundingBox, var14, i, 0, var14, i + 2, 7, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
					this.fillWithOutline(structureWorldAccess, boundingBox, var14, i + 1, 0, var14, i + 1, 7, PRISMARINE, PRISMARINE, false);
				}
	...
	public static class DoubleYZRoom extends OceanMonumentGenerator.Piece {
		...
		public boolean generate(
			...
			for (int i = 1; i <= 7; i++) {
				...
				this.fillWithOutline(structureWorldAccess, boundingBox, 0, i, 0, 0, i, 15, blockState, blockState, false);
				this.fillWithOutline(structureWorldAccess, boundingBox, 7, i, 0, 7, i, 15, blockState, blockState, false);
				this.fillWithOutline(structureWorldAccess, boundingBox, 1, i, 0, 6, i, 0, blockState, blockState, false);
				this.fillWithOutline(structureWorldAccess, boundingBox, 1, i, 15, 6, i, 15, blockState, blockState, false);
			}
	...
	public static class WingRoom extends OceanMonumentGenerator.Piece {
		...
		public boolean generate(
			...
			if (this.field_14481 == 0) {
				for (int i = 0; i < 4; i++) {
					this.fillWithOutline(structureWorldAccess, boundingBox, 10 - i, 3 - i, 20 - i, 12 + i, 3 - i, 20, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
				}
				...
				for (int o = 0; o < 2; o++) {
					this.fillWithOutline(structureWorldAccess, boundingBox, var14, 0, 10, var14, 6, 10, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
					this.fillWithOutline(structureWorldAccess, boundingBox, var14, 0, 12, var14, 6, 12, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
					this.addBlock(structureWorldAccess, SEA_LANTERN, var14, 0, 10, boundingBox);
					this.addBlock(structureWorldAccess, SEA_LANTERN, var14, 0, 12, boundingBox);
					this.addBlock(structureWorldAccess, SEA_LANTERN, var14, 4, 10, boundingBox);
					this.addBlock(structureWorldAccess, SEA_LANTERN, var14, 4, 12, boundingBox);
					var14 = 12;
				}
				...
				for (int p = 0; p < 2; p++) {
					this.fillWithOutline(structureWorldAccess, boundingBox, var14, 0, 7, var14, 2, 7, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
					this.fillWithOutline(structureWorldAccess, boundingBox, var14, 0, 14, var14, 2, 14, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
					var14 = 14;
				}
