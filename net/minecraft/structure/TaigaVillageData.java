	...
	static {
		...
		StructurePools.register(
			new StructurePool(
				...
				new Identifier("empty"),
				ImmutableList.of(
					Pair.of(StructurePoolElement.method_30425("village/taiga/taiga_lamp_post_1"), 10),
					Pair.of(StructurePoolElement.method_30425("village/taiga/taiga_decoration_1"), 4),
					...
					new Pair[]{Pair.of(StructurePoolElement.method_30438(), 4)}
				),
				StructurePool.Projection.RIGID
			)
		);
		...
		StructurePools.register(
			new StructurePool(
				...
				new Identifier("empty"),
				ImmutableList.of(
					Pair.of(StructurePoolElement.method_30425("village/taiga/villagers/nitwit"), 1),
