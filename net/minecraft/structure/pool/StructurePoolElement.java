...
public abstract class StructurePoolElement {
	...
	public <T> Dynamic<T> method_16755(DynamicOps<T> dynamicOps) {
		T object = (T)this.method_16625(dynamicOps).getValue();
		T object2 = (T)dynamicOps.mergeInto(
			object, dynamicOps.createString("element_type"), dynamicOps.createString(Registry.field_16793.getId(this.getType()).toString())
		);
