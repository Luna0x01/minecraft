...
public class DesertTempleGenerator extends StructurePieceWithDimensions {
	...
	public boolean generate(
		...
		this.fillWithOutline(
			structureWorldAccess, boundingBox, this.width - 5, 0, 0, this.width - 1, 9, 4, Blocks.SANDSTONE.getDefaultState(), Blocks.AIR.getDefaultState(), false
		);
		this.fillWithOutline(
			structureWorldAccess,
			boundingBox,
		...
		this.fillWithOutline(
			structureWorldAccess, boundingBox, 5, 4, 5, this.width - 6, 4, this.depth - 6, Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false
		);
		...
		this.fillWithOutline(
			structureWorldAccess, boundingBox, 8, 1, 8, 8, 3, 8, Blocks.CUT_SANDSTONE.getDefaultState(), Blocks.CUT_SANDSTONE.getDefaultState(), false
		);
		this.fillWithOutline(
			structureWorldAccess, boundingBox, 12, 1, 8, 12, 3, 8, Blocks.CUT_SANDSTONE.getDefaultState(), Blocks.CUT_SANDSTONE.getDefaultState(), false
		);
		this.fillWithOutline(
			structureWorldAccess, boundingBox, 8, 1, 12, 8, 3, 12, Blocks.CUT_SANDSTONE.getDefaultState(), Blocks.CUT_SANDSTONE.getDefaultState(), false
		);
		this.fillWithOutline(
			structureWorldAccess, boundingBox, 12, 1, 12, 12, 3, 12, Blocks.CUT_SANDSTONE.getDefaultState(), Blocks.CUT_SANDSTONE.getDefaultState(), false
		);
		...
		this.fillWithOutline(
			structureWorldAccess, boundingBox, 5, 5, 9, 5, 7, 11, Blocks.CUT_SANDSTONE.getDefaultState(), Blocks.CUT_SANDSTONE.getDefaultState(), false
		);
		this.fillWithOutline(
			structureWorldAccess,
			boundingBox,
		...
		this.fillWithOutline(
			structureWorldAccess, boundingBox, this.width - 3, 4, 4, this.width - 3, 6, 4, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false
		);
		...
		this.fillWithOutline(
			structureWorldAccess, boundingBox, this.width - 3, 1, 3, this.width - 2, 2, 3, Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false
		);
		...
		this.fillWithOutline(
			structureWorldAccess, boundingBox, this.width - 6, 1, 5, this.width - 5, 2, 16, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false
		);

		for (int m = 5; m <= 17; m += 2) {
			this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), 4, 1, m, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.CHISELED_SANDSTONE.getDefaultState(), 4, 2, m, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), this.width - 5, 1, m, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.CHISELED_SANDSTONE.getDefaultState(), this.width - 5, 2, m, boundingBox);
		}
		...
		for (int n = 0; n <= this.width - 1; n += this.width - 1) {
			this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), n, 2, 1, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 2, 2, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), n, 2, 3, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), n, 3, 1, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 3, 2, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), n, 3, 3, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 4, 1, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.CHISELED_SANDSTONE.getDefaultState(), n, 4, 2, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 4, 3, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), n, 5, 1, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 5, 2, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), n, 5, 3, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 6, 1, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.CHISELED_SANDSTONE.getDefaultState(), n, 6, 2, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 6, 3, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 7, 1, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 7, 2, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 7, 3, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), n, 8, 1, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), n, 8, 2, boundingBox);
			this.addBlock(structureWorldAccess, Blocks.CUT_SANDSTONE.getDefaultState(), n, 8, 3, boundingBox);
		}
		...
		this.fillWithOutline(
			structureWorldAccess, boundingBox, 8, 4, 0, 12, 6, 0, Blocks.CUT_SANDSTONE.getDefaultState(), Blocks.CUT_SANDSTONE.getDefaultState(), false
		);
		...
		this.fillWithOutline(
			structureWorldAccess, boundingBox, 8, -14, 8, 12, -11, 12, Blocks.CUT_SANDSTONE.getDefaultState(), Blocks.CUT_SANDSTONE.getDefaultState(), false
		);
		this.fillWithOutline(
			structureWorldAccess, boundingBox, 8, -10, 8, 12, -10, 12, Blocks.CHISELED_SANDSTONE.getDefaultState(), Blocks.CHISELED_SANDSTONE.getDefaultState(), false
		);
		this.fillWithOutline(
			structureWorldAccess, boundingBox, 8, -9, 8, 12, -9, 12, Blocks.CUT_SANDSTONE.getDefaultState(), Blocks.CUT_SANDSTONE.getDefaultState(), false
		);
		...
		for (Direction direction : Direction.Type.HORIZONTAL) {
			if (!this.hasPlacedChest[direction.getHorizontal()]) {
				...
				this.hasPlacedChest[direction.getHorizontal()] = this.addChest(
					structureWorldAccess, boundingBox, random, 10 + p, -11, 10 + q, LootTables.DESERT_PYRAMID_CHEST
				);
			}
		}
