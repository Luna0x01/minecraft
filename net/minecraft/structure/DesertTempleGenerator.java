	...
	public boolean generate(IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox, ChunkPos chunkPos) {
		...
		for (int j = 0; j < this.width; j++) {
			for (int k = 0; k < this.depth; k++) {
				int l = -5;
				this.method_14936(iWorld, Blocks.field_9979.getDefaultState(), j, -5, k, mutableIntBoundingBox);
			}
		}
		...
		for (int m = 5; m <= 17; m += 2) {
			this.addBlock(iWorld, Blocks.field_10361.getDefaultState(), 4, 1, m, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10292.getDefaultState(), 4, 2, m, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10361.getDefaultState(), this.width - 5, 1, m, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10292.getDefaultState(), this.width - 5, 2, m, mutableIntBoundingBox);
		}
		...
		for (int n = 0; n <= this.width - 1; n += this.width - 1) {
			this.addBlock(iWorld, Blocks.field_10361.getDefaultState(), n, 2, 1, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10184.getDefaultState(), n, 2, 2, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10361.getDefaultState(), n, 2, 3, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10361.getDefaultState(), n, 3, 1, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10184.getDefaultState(), n, 3, 2, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10361.getDefaultState(), n, 3, 3, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10184.getDefaultState(), n, 4, 1, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10292.getDefaultState(), n, 4, 2, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10184.getDefaultState(), n, 4, 3, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10361.getDefaultState(), n, 5, 1, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10184.getDefaultState(), n, 5, 2, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10361.getDefaultState(), n, 5, 3, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10184.getDefaultState(), n, 6, 1, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10292.getDefaultState(), n, 6, 2, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10184.getDefaultState(), n, 6, 3, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10184.getDefaultState(), n, 7, 1, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10184.getDefaultState(), n, 7, 2, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10184.getDefaultState(), n, 7, 3, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10361.getDefaultState(), n, 8, 1, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10361.getDefaultState(), n, 8, 2, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10361.getDefaultState(), n, 8, 3, mutableIntBoundingBox);
		}

		for (int o = 2; o <= this.width - 3; o += this.width - 3 - 2) {
			this.addBlock(iWorld, Blocks.field_10361.getDefaultState(), o - 1, 2, 0, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10184.getDefaultState(), o, 2, 0, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10361.getDefaultState(), o + 1, 2, 0, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10361.getDefaultState(), o - 1, 3, 0, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10184.getDefaultState(), o, 3, 0, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10361.getDefaultState(), o + 1, 3, 0, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10184.getDefaultState(), o - 1, 4, 0, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10292.getDefaultState(), o, 4, 0, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10184.getDefaultState(), o + 1, 4, 0, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10361.getDefaultState(), o - 1, 5, 0, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10184.getDefaultState(), o, 5, 0, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10361.getDefaultState(), o + 1, 5, 0, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10184.getDefaultState(), o - 1, 6, 0, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10292.getDefaultState(), o, 6, 0, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10184.getDefaultState(), o + 1, 6, 0, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10184.getDefaultState(), o - 1, 7, 0, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10184.getDefaultState(), o, 7, 0, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10184.getDefaultState(), o + 1, 7, 0, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10361.getDefaultState(), o - 1, 8, 0, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10361.getDefaultState(), o, 8, 0, mutableIntBoundingBox);
			this.addBlock(iWorld, Blocks.field_10361.getDefaultState(), o + 1, 8, 0, mutableIntBoundingBox);
		}
		...
		for (Direction direction : Direction.Type.field_11062) {
			if (!this.hasPlacedChest[direction.getHorizontal()]) {
				...
				this.hasPlacedChest[direction.getHorizontal()] = this.addChest(iWorld, mutableIntBoundingBox, random, 10 + p, -11, 10 + q, LootTables.field_885);
			}
		}
