	...
	public boolean generate(
		...
		for (int j = 0; j < this.width; j++) {
			for (int k = 0; k < this.depth; k++) {
				int l = -5;
				this.fillDownwards(world, Blocks.SANDSTONE.getDefaultState(), j, -5, k, boundingBox);
			}
		}
		...
		for (int m = 5; m <= 17; m += 2) {
			this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), 4, 1, m, boundingBox);
			this.addBlock(world, Blocks.CHISELED_SANDSTONE.getDefaultState(), 4, 2, m, boundingBox);
			this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), this.width - 5, 1, m, boundingBox);
			this.addBlock(world, Blocks.CHISELED_SANDSTONE.getDefaultState(), this.width - 5, 2, m, boundingBox);
		}
		...
		for (int n = 0; n <= this.width - 1; n += this.width - 1) {
			this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), n, 2, 1, boundingBox);
			this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 2, 2, boundingBox);
			this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), n, 2, 3, boundingBox);
			this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), n, 3, 1, boundingBox);
			this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 3, 2, boundingBox);
			this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), n, 3, 3, boundingBox);
			this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 4, 1, boundingBox);
			this.addBlock(world, Blocks.CHISELED_SANDSTONE.getDefaultState(), n, 4, 2, boundingBox);
			this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 4, 3, boundingBox);
			this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), n, 5, 1, boundingBox);
			this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 5, 2, boundingBox);
			this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), n, 5, 3, boundingBox);
			this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 6, 1, boundingBox);
			this.addBlock(world, Blocks.CHISELED_SANDSTONE.getDefaultState(), n, 6, 2, boundingBox);
			this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 6, 3, boundingBox);
			this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 7, 1, boundingBox);
			this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 7, 2, boundingBox);
			this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), n, 7, 3, boundingBox);
			this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), n, 8, 1, boundingBox);
			this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), n, 8, 2, boundingBox);
			this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), n, 8, 3, boundingBox);
		}

		for (int o = 2; o <= this.width - 3; o += this.width - 3 - 2) {
			this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o - 1, 2, 0, boundingBox);
			this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 2, 0, boundingBox);
			this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o + 1, 2, 0, boundingBox);
			this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o - 1, 3, 0, boundingBox);
			this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 3, 0, boundingBox);
			this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o + 1, 3, 0, boundingBox);
			this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o - 1, 4, 0, boundingBox);
			this.addBlock(world, Blocks.CHISELED_SANDSTONE.getDefaultState(), o, 4, 0, boundingBox);
			this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o + 1, 4, 0, boundingBox);
			this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o - 1, 5, 0, boundingBox);
			this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 5, 0, boundingBox);
			this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o + 1, 5, 0, boundingBox);
			this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o - 1, 6, 0, boundingBox);
			this.addBlock(world, Blocks.CHISELED_SANDSTONE.getDefaultState(), o, 6, 0, boundingBox);
			this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o + 1, 6, 0, boundingBox);
			this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o - 1, 7, 0, boundingBox);
			this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 7, 0, boundingBox);
			this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o + 1, 7, 0, boundingBox);
			this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o - 1, 8, 0, boundingBox);
			this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o, 8, 0, boundingBox);
			this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o + 1, 8, 0, boundingBox);
		}
		...
		for (Direction direction : Direction.Type.HORIZONTAL) {
			if (!this.hasPlacedChest[direction.getHorizontal()]) {
				...
				this.hasPlacedChest[direction.getHorizontal()] = this.addChest(world, boundingBox, random, 10 + p, -11, 10 + q, LootTables.DESERT_PYRAMID_CHEST);
			}
		}
