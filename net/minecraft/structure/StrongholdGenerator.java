...
public class StrongholdGenerator {
	...
	public static class ChestCorridor extends StrongholdGenerator.Piece {
		...
		public boolean generate(IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox, ChunkPos chunkPos) {
			...
			if (!this.chestGenerated && mutableIntBoundingBox.contains(new BlockPos(this.applyXTransform(3, 3), this.applyYTransform(2), this.applyZTransform(3, 3)))) {
				...
				this.addChest(iWorld, mutableIntBoundingBox, random, 3, 2, 3, LootTables.field_842);
			}
	...
	public static class Library extends StrongholdGenerator.Piece {
		...
		public boolean generate(IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox, ChunkPos chunkPos) {
			...
			for (int m = 3; m < 12; m += 2) {
				this.fillWithOutline(iWorld, mutableIntBoundingBox, 3, 1, m, 4, 3, m, Blocks.field_10504.getDefaultState(), Blocks.field_10504.getDefaultState(), false);
				this.fillWithOutline(iWorld, mutableIntBoundingBox, 6, 1, m, 7, 3, m, Blocks.field_10504.getDefaultState(), Blocks.field_10504.getDefaultState(), false);
				this.fillWithOutline(iWorld, mutableIntBoundingBox, 9, 1, m, 10, 3, m, Blocks.field_10504.getDefaultState(), Blocks.field_10504.getDefaultState(), false);
			}
			...
			this.addChest(iWorld, mutableIntBoundingBox, random, 3, 3, 5, LootTables.field_683);
			if (this.tall) {
				this.addBlock(iWorld, AIR, 12, 9, 1, mutableIntBoundingBox);
				this.addChest(iWorld, mutableIntBoundingBox, random, 12, 8, 1, LootTables.field_683);
			}
	...
	public static class PortalRoom extends StrongholdGenerator.Piece {
		...
		public boolean generate(IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox, ChunkPos chunkPos) {
			...
			for (int k = 2; k < 9; k += 2) {
				this.fillWithOutline(iWorld, mutableIntBoundingBox, k, 3, 15, k, 4, 15, blockState2, blockState2, false);
			}
			...
			for (int l = 4; l <= 6; l++) {
				this.addBlock(iWorld, blockState3, l, 1, 4, mutableIntBoundingBox);
				this.addBlock(iWorld, blockState3, l, 2, 5, mutableIntBoundingBox);
				this.addBlock(iWorld, blockState3, l, 3, 6, mutableIntBoundingBox);
			}
	...
	public static class SmallCorridor extends StrongholdGenerator.Piece {
		...
		public SmallCorridor(int i, MutableIntBoundingBox mutableIntBoundingBox, Direction direction) {
			...
			this.setOrientation(direction);
			this.boundingBox = mutableIntBoundingBox;
			this.length = direction != Direction.field_11043 && direction != Direction.field_11035
	...
	public static class SquareRoom extends StrongholdGenerator.Piece {
		...
		public boolean generate(IWorld iWorld, Random random, MutableIntBoundingBox mutableIntBoundingBox, ChunkPos chunkPos) {
			...
			switch (this.roomType) {
				...
				case 2:
					for (int j = 1; j <= 9; j++) {
						this.addBlock(iWorld, Blocks.field_10445.getDefaultState(), 1, 3, j, mutableIntBoundingBox);
						this.addBlock(iWorld, Blocks.field_10445.getDefaultState(), 9, 3, j, mutableIntBoundingBox);
					}

					for (int k = 1; k <= 9; k++) {
						this.addBlock(iWorld, Blocks.field_10445.getDefaultState(), k, 3, 1, mutableIntBoundingBox);
						this.addBlock(iWorld, Blocks.field_10445.getDefaultState(), k, 3, 9, mutableIntBoundingBox);
					}
					...
					for (int l = 1; l <= 3; l++) {
						this.addBlock(iWorld, Blocks.field_10445.getDefaultState(), 4, l, 4, mutableIntBoundingBox);
						this.addBlock(iWorld, Blocks.field_10445.getDefaultState(), 6, l, 4, mutableIntBoundingBox);
						this.addBlock(iWorld, Blocks.field_10445.getDefaultState(), 4, l, 6, mutableIntBoundingBox);
						this.addBlock(iWorld, Blocks.field_10445.getDefaultState(), 6, l, 6, mutableIntBoundingBox);
					}

					this.addBlock(iWorld, Blocks.field_10336.getDefaultState(), 5, 3, 5, mutableIntBoundingBox);

					for (int m = 2; m <= 8; m++) {
						this.addBlock(iWorld, Blocks.field_10161.getDefaultState(), 2, 3, m, mutableIntBoundingBox);
						this.addBlock(iWorld, Blocks.field_10161.getDefaultState(), 3, 3, m, mutableIntBoundingBox);
						if (m <= 3 || m >= 7) {
							this.addBlock(iWorld, Blocks.field_10161.getDefaultState(), 4, 3, m, mutableIntBoundingBox);
							this.addBlock(iWorld, Blocks.field_10161.getDefaultState(), 5, 3, m, mutableIntBoundingBox);
							this.addBlock(iWorld, Blocks.field_10161.getDefaultState(), 6, 3, m, mutableIntBoundingBox);
						}

						this.addBlock(iWorld, Blocks.field_10161.getDefaultState(), 7, 3, m, mutableIntBoundingBox);
						this.addBlock(iWorld, Blocks.field_10161.getDefaultState(), 8, 3, m, mutableIntBoundingBox);
					}
					...
					this.addChest(iWorld, mutableIntBoundingBox, random, 3, 4, 8, LootTables.field_800);
			}
