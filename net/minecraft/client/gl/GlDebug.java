...
public class GlDebug {
	...
	private static final Map<String, List<String>> field_4923 = Maps.newHashMap();
		...
		if (i > 0) {
			...
			if (gLCapabilities.GL_KHR_debug) {
				...
				for (int k = 0; k < ARB_VERBOSITY_LEVELS.size(); k++) {
					boolean bl3 = k < i;
					ARBDebugOutput.glDebugMessageControlARB(4352, 4352, (Integer)ARB_VERBOSITY_LEVELS.get(k), (int[])null, bl3);
				}
