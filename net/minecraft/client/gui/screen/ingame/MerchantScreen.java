...
public class MerchantScreen extends ContainerScreen<MerchantContainer> {
	...
	protected void drawForeground(int i, int j) {
		...
		if (k > 0 && k <= 5 && this.container.isLevelled()) {
			...
			String string3 = this.title.asFormattedString();
			this.font.draw(string3, (float)(49 + this.containerWidth / 2 - this.font.getStringWidth(string3) / 2), 6.0F, 4210752);
			this.font.draw(this.playerInventory.getDisplayName().asFormattedString(), 107.0F, (float)l, 4210752);
		}

		String string4 = I18n.translate("merchant.trades");
		int q = this.font.getStringWidth(string4);
		this.font.draw(string4, (float)(5 - q / 2 + 48), 6.0F, 4210752);
	}
