...
public class RecipeAlternatesWidget extends DrawableHelper implements Drawable, Element {
	...
	private final List<RecipeAlternatesWidget.AlternateButtonWidget> alternateButtons = Lists.newArrayList();
	...
	class AlternateButtonWidget extends AbstractButtonWidget implements RecipeGridAligner<Ingredient> {
		...
		protected final List<RecipeAlternatesWidget.AlternateButtonWidget.InputSlot> slots = Lists.newArrayList();
