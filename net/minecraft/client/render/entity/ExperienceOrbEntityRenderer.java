...
public class ExperienceOrbEntityRenderer extends EntityRenderer<ExperienceOrbEntity> {
	...
	public void render(ExperienceOrbEntity experienceOrbEntity, double d, double e, double f, float g, float h) {
		...
		bufferBuilder.vertex((double)(0.0F - o), (double)(0.0F - p), 0.0).texture((double)j, (double)m).color(s, 255, x, 128).normal(0.0F, 1.0F, 0.0F).next();
		bufferBuilder.vertex((double)(n - o), (double)(0.0F - p), 0.0).texture((double)k, (double)m).color(s, 255, x, 128).normal(0.0F, 1.0F, 0.0F).next();
		bufferBuilder.vertex((double)(n - o), (double)(1.0F - p), 0.0).texture((double)k, (double)l).color(s, 255, x, 128).normal(0.0F, 1.0F, 0.0F).next();
		bufferBuilder.vertex((double)(0.0F - o), (double)(1.0F - p), 0.0).texture((double)j, (double)l).color(s, 255, x, 128).normal(0.0F, 1.0F, 0.0F).next();
		tessellator.draw();
