...
public abstract class EntityRenderer<T extends Entity> {
	...
	public final int getLight(T entity, float f) {
		return LightmapTextureManager.pack(this.getBlockLight(entity, f), entity.world.getLightLevel(LightType.field_9284, new BlockPos(entity.getCameraPosVec(f))));
	}

	protected int getBlockLight(T entity, float f) {
		return entity.isOnFire() ? 15 : entity.world.getLightLevel(LightType.field_9282, new BlockPos(entity.getCameraPosVec(f)));
	}
