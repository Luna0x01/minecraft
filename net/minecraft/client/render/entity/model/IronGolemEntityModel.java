...
public class IronGolemEntityModel extends EntityModel {
	...
	public IronGolemEntityModel(float f, float g) {
		int i = 128;
		int j = 128;
		this.field_1551 = new ModelPart(this).setTextureSize(128, 128);
		...
		this.field_1552 = new ModelPart(this).setTextureSize(128, 128);
