...
public class SnowmanEntityModel extends EntityModel {
	...
	public SnowmanEntityModel() {
		...
		this.field_1532.addCuboid(-4.0F, -8.0F, -4.0F, 8, 8, 8, g - 0.5F);
		this.field_1532.setPivot(0.0F, 0.0F + f, 0.0F);
		this.field_1533 = new ModelPart(this, 32, 0).setTextureSize(64, 64);
		this.field_1533.addCuboid(-1.0F, 0.0F, -1.0F, 12, 2, 2, g - 0.5F);
		this.field_1533.setPivot(0.0F, 0.0F + f + 9.0F - 7.0F, 0.0F);
		this.field_1534 = new ModelPart(this, 32, 0).setTextureSize(64, 64);
		this.field_1534.addCuboid(-1.0F, 0.0F, -1.0F, 12, 2, 2, g - 0.5F);
		this.field_1534.setPivot(0.0F, 0.0F + f + 9.0F - 7.0F, 0.0F);
		this.field_1530 = new ModelPart(this, 0, 16).setTextureSize(64, 64);
		this.field_1530.addCuboid(-5.0F, -10.0F, -5.0F, 10, 10, 10, g - 0.5F);
		this.field_1530.setPivot(0.0F, 0.0F + f + 9.0F, 0.0F);
		this.field_1531 = new ModelPart(this, 0, 36).setTextureSize(64, 64);
		this.field_1531.addCuboid(-6.0F, -12.0F, -6.0F, 12, 12, 12, g - 0.5F);
		this.field_1531.setPivot(0.0F, 0.0F + f + 20.0F, 0.0F);
	}
