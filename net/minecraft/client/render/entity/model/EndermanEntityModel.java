...
public class EndermanEntityModel extends BiPedModel {
	...
	public EndermanEntityModel(float f) {
		...
		this.rightArm.setPivot(-3.0F, 2.0F + g, 0.0F);
	...
	public void setAngles(float handSwing, float handSwingAmount, float tickDelta, float age, float headPitch, float scale, Entity entity) {
		...
		float g = 0.4F;
		if (this.rightArm.posX > g) {
			this.rightArm.posX = g;
		}

		if (this.leftArm.posX > g) {
			this.leftArm.posX = g;
		}
		...
		if (this.rightLeg.posX > g) {
			this.rightLeg.posX = g;
		}

		if (this.leftLeg.posX > g) {
			this.leftLeg.posX = g;
		}
		...
		this.rightLeg.pivotY = 9.0F + f;
		this.leftLeg.pivotY = 9.0F + f;
		this.head.pivotZ = -0.0F;
		this.head.pivotY = f + 1.0F;
