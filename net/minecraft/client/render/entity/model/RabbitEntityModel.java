...
public class RabbitEntityModel<T extends RabbitEntity> extends EntityModel<T> {
	...
	public RabbitEntityModel() {
		...
		this.setAngle(this.leftBackLeg, (float) (-Math.PI / 9), 0.0F, 0.0F);
		...
		this.setAngle(this.leftFrontLeg, (float) (-Math.PI / 18), 0.0F, 0.0F);
		...
		this.setAngle(this.rightFrontLeg, (float) (-Math.PI / 18), 0.0F, 0.0F);
		...
		this.setAngle(this.rightEar, 0.0F, (float) (-Math.PI / 12), 0.0F);
		...
		this.setAngle(this.leftEar, 0.0F, (float) (Math.PI / 12), 0.0F);
