			...
			if (!blockState.isOf(Blocks.AIR)) {
				...
				for (Box box : voxelShape.getBoundingBoxes()) {
					...
					if (blockState.isSideSolidFullSquare(blockView, blockPos2, Direction.SOUTH)) {
						...
						bufferBuilder2.begin(VertexFormat.DrawMode.TRIANGLE_STRIP, VertexFormats.POSITION_COLOR);
					...
					if (blockState.isSideSolidFullSquare(blockView, blockPos2, Direction.EAST)) {
						...
						bufferBuilder3.begin(VertexFormat.DrawMode.TRIANGLE_STRIP, VertexFormats.POSITION_COLOR);
					...
					if (blockState.isSideSolidFullSquare(blockView, blockPos2, Direction.NORTH)) {
						...
						bufferBuilder4.begin(VertexFormat.DrawMode.TRIANGLE_STRIP, VertexFormats.POSITION_COLOR);
					...
					if (blockState.isSideSolidFullSquare(blockView, blockPos2, Direction.DOWN)) {
						...
						bufferBuilder5.begin(VertexFormat.DrawMode.TRIANGLE_STRIP, VertexFormats.POSITION_COLOR);
					...
					if (blockState.isSideSolidFullSquare(blockView, blockPos2, Direction.UP)) {
						...
						bufferBuilder6.begin(VertexFormat.DrawMode.TRIANGLE_STRIP, VertexFormats.POSITION_COLOR);
