...
public class PointOfInterestDebugRenderer implements DebugRenderer.Renderer {
	...
	private final Map<BlockPos, PointOfInterestDebugRenderer.class_4233> pointsOfInterest = Maps.newHashMap();
	private final Set<ChunkSectionPos> field_18788 = Sets.newHashSet();
	private final Map<UUID, PointOfInterestDebugRenderer.class_4232> field_18921 = Maps.newHashMap();
	...
	private void method_20571(PointOfInterestDebugRenderer.class_4232 arg) {
		...
		if (bl) {
			for (String string2 : arg.field_18927) {
				method_19704(arg.field_18926, i, string2, -16711936, 0.02F);
				i++;
			}
		}
		...
		if (bl) {
			for (String string3 : arg.field_19375) {
				if (string3.startsWith(arg.field_19328)) {
					method_19704(arg.field_18926, i, string3, -1, 0.02F);
				} else {
					method_19704(arg.field_18926, i, string3, -23296, 0.02F);
				}
		...
		if (bl) {
			for (String string4 : Lists.reverse(arg.field_19374)) {
				method_19704(arg.field_18926, i, string4, -3355444, 0.02F);
				i++;
			}
		}
