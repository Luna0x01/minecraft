...
public abstract class GeneratorType {
	...
	protected static final List<GeneratorType> VALUES = Lists.newArrayList(
		new GeneratorType[]{DEFAULT, FLAT, LARGE_BIOMES, AMPLIFIED, SINGLE_BIOME_SURFACE, SINGLE_BIOME_CAVES, SINGLE_BIOME_FLOATING_ISLANDS, DEBUG_ALL_BLOCK_STATES}
	);
	protected static final Map<Optional<GeneratorType>, GeneratorType.ScreenProvider> SCREEN_PROVIDERS = ImmutableMap.of(
		Optional.of(FLAT),
		(GeneratorType.ScreenProvider)(screen, generatorOptions) -> {
		...
		(GeneratorType.ScreenProvider)(screen, generatorOptions) -> new CustomizeBuffetLevelScreen(
				screen,
