...
public class class_4492 extends DataFix {
	public static final Map<String, String> field_22265 = ImmutableMap.builder()
	...
	public class_4492(Schema schema, boolean bl) {
		super(schema, bl);
	}

	protected TypeRewriteRule makeRule() {
		Type<Pair<String, String>> type = DSL.named(class_3402.field_16604.typeName(), DSL.namespacedString());
		if (!Objects.equals(type, this.getInputSchema().getType(class_3402.field_16604))) {
			throw new IllegalStateException("Biome type is not what was expected.");
		} else {
			return this.fixTypeEverywhere("Biomes fix", type, dynamicOps -> pair -> pair.mapSecond(string -> (String)field_22265.getOrDefault(string, string)));
		}
	}
}
