...
public class class_3232 implements Criterion<class_3232.class_3234> {
	...
	@Override
	public void method_14973(AdvancementFile file, Criterion.class_3353<class_3232.class_3234> arg) {
	...
	@Override
	public void method_14974(AdvancementFile file, Criterion.class_3353<class_3232.class_3234> arg) {
		class_3232.class_3233 lv = (class_3232.class_3233)this.field_15814.get(file);
		if (lv != null) {
			lv.method_14403(arg);
			if (lv.method_14400()) {
	...
	public class_3232.class_3234 fromJson(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext) {
		EntityJson entityJson = EntityJson.fromJson(jsonObject.get("entity"));
		return new class_3232.class_3234(entityJson);
	}
	...
	static class class_3233 {
		...
		private final Set<Criterion.class_3353<class_3232.class_3234>> field_15816 = Sets.newHashSet();
		...
		public void method_14402(Criterion.class_3353<class_3232.class_3234> arg) {
			this.field_15816.add(arg);
		}

		public void method_14403(Criterion.class_3353<class_3232.class_3234> arg) {
			this.field_15816.remove(arg);
		}

		public void method_14401(ServerPlayerEntity serverPlayerEntity, Entity entity) {
			List<Criterion.class_3353<class_3232.class_3234>> list = null;

			for (Criterion.class_3353<class_3232.class_3234> lv : this.field_15816) {
				if (lv.method_14975().method_14404(serverPlayerEntity, entity)) {
					if (list == null) {
			...
			if (list != null) {
				for (Criterion.class_3353<class_3232.class_3234> lv2 : list) {
	...
	public static class class_3234 extends AbstractCriterionInstance {
		private final EntityJson field_15817;

		public class_3234(EntityJson entityJson) {
			super(class_3232.field_15813);
			this.field_15817 = entityJson;
		}

		public boolean method_14404(ServerPlayerEntity serverPlayerEntity, Entity entity) {
			return this.field_15817.method_14237(serverPlayerEntity, entity);
		}
	}
}
