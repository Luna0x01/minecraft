package net.minecraft.states.property;
...
public class Properties {
	...
	public static final DirectionProperty HORIZONTAL_FACING = DirectionProperty.of("facing", Direction.DirectionType.HORIZONTAL);
