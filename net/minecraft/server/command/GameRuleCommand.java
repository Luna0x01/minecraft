			...
			new GameRules.RuleTypeConsumer() {
				...
				public <T extends GameRules.Rule<T>> void accept(GameRules.RuleKey<T> ruleKey, GameRules.RuleType<T> ruleType) {
					literalArgumentBuilder.then(
						((LiteralArgumentBuilder)CommandManager.literal(ruleKey.getName())
								.executes(commandContext -> GameRuleCommand.executeQuery((ServerCommandSource)commandContext.getSource(), ruleKey)))
