	...
	public static class Deserializer implements JsonDeserializer<ServerMetadata>, JsonSerializer<ServerMetadata> {
		public ServerMetadata method_12691(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
			...
			if (jsonObject.has("players")) {
				serverMetadata.setPlayers((ServerMetadata.Players)jsonDeserializationContext.deserialize(jsonObject.get("players"), ServerMetadata.Players.class));
			}

			if (jsonObject.has("version")) {
				serverMetadata.setVersion((ServerMetadata.Version)jsonDeserializationContext.deserialize(jsonObject.get("version"), ServerMetadata.Version.class));
			}
