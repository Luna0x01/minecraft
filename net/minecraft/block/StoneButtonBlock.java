...
public class StoneButtonBlock extends AbstractButtonBlock {
	...
	protected void method_11580(@Nullable PlayerEntity playerEntity, World world, BlockPos blockPos) {
		world.method_11486(playerEntity, blockPos, Sounds.BLOCK_STONE_BUTTON_CLICK_ON, SoundCategory.BLOCKS, 0.3F, 0.6F);
	}

	@Override
	protected void method_11581(World world, BlockPos blockPos) {
		world.method_11486(null, blockPos, Sounds.BLOCK_STONE_BUTTON_CLICK_OFF, SoundCategory.BLOCKS, 0.3F, 0.5F);
	}
}
