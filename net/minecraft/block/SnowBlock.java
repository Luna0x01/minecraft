...
public class SnowBlock extends Block {
	...
	public boolean canPlaceAt(BlockState blockState, WorldView worldView, BlockPos blockPos) {
		...
		if (block == Blocks.field_10295 || block == Blocks.field_10225 || block == Blocks.field_10499) {
			...
			return block != Blocks.field_21211 && block != Blocks.field_10114
				? Block.isFaceFullSquare(blockState2.getCollisionShape(worldView, blockPos.down()), Direction.field_11036)
	...
	public void scheduledTick(BlockState blockState, ServerWorld serverWorld, BlockPos blockPos, Random random) {
		if (serverWorld.getLightLevel(LightType.field_9282, blockPos) > 11) {
