...
public class ConcretePowderBlock extends FallingBlock {
	...
	public void onLanding(World world, BlockPos blockPos, BlockState blockState, BlockState blockState2) {
		if (method_24279(world, blockPos, blockState2)) {
	...
	public BlockState getPlacementState(ItemPlacementContext itemPlacementContext) {
		...
		return method_24279(blockView, blockPos, blockState) ? this.hardenedState : super.getPlacementState(itemPlacementContext);
	}
