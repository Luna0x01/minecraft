...
public class LootContextTypes {
	...
	public static final LootContextType field_20761 = register(
		"command", builder -> builder.require(LootContextParameters.field_1232).allow(LootContextParameters.field_1226)
	);
	public static final LootContextType field_20762 = register(
		"selector", builder -> builder.require(LootContextParameters.field_1232).require(LootContextParameters.field_1226)
	);
