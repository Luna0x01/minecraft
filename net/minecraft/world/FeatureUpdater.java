		...
		if (persistentStateManager != null) {
			for (String string : this.field_17658) {
				...
				for (String string2 : nbtCompound.getKeys()) {
					...
					((Long2ObjectMap)this.featureIdToChunkNbt.computeIfAbsent(string5, stringx -> new Long2ObjectOpenHashMap())).put(l, nbtCompound2);
				}

				String string6 = string + "_index";
				ChunkUpdateState chunkUpdateState = persistentStateManager.getOrCreate(ChunkUpdateState::fromNbt, ChunkUpdateState::new, string6);
