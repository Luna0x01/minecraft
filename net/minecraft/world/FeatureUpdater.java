		...
		if (persistentStateManager != null) {
			for (String string : this.field_17658) {
				...
				for (String string2 : compoundTag.getKeys()) {
					...
					((Long2ObjectMap)this.featureIdToChunkTag.computeIfAbsent(string5, stringx -> new Long2ObjectOpenHashMap())).put(l, compoundTag2);
				}

				String string6 = string + "_index";
				ChunkUpdateState chunkUpdateState = persistentStateManager.getOrCreate(() -> new ChunkUpdateState(string6), string6);
