	...
	protected SavannaBiome() {
		super(
			new Biome.Builder()
				...
				.setCategory(Biome.Category.SAVANNA)
				.setDepth(0.125F)
				.setScale(0.05F)
				.setTemperature(1.2F)
				.setDownfall(0.0F)
		...
		this.method_16436(class_3844.field_19181, new class_3911(0, VillagePieces.class_3996.ACACIA));
		...
		this.method_16432(
			...
			method_16433(class_3844.field_19164, new class_3840(Blocks.TALL_GRASS.getDefaultState()), field_17607, new class_3935(7))
		);
		this.method_16432(
		...
		this.method_16432(
			...
			method_16433(
				...
				new class_3880(
					new class_3844[]{class_3844.field_19202}, new class_3845[]{class_3845.field_19203}, new float[]{0.8F}, class_3844.field_19123, class_3845.field_19203
				),
				field_17617,
				new class_3937(1, 0.1F, 1)
			)
		);
		...
		this.method_16432(
			class_3801.class_3803.VEGETAL_DECORATION,
			method_16433(class_3844.field_19133, new class_3909(Blocks.GRASS.getDefaultState()), field_17608, new class_3935(20))
		);
		this.method_16432(
		...
		this.method_16425(EntityCategory.PASSIVE, new Biome.SpawnEntry(EntityType.HORSE, 1, 2, 6));
		this.method_16425(EntityCategory.PASSIVE, new Biome.SpawnEntry(EntityType.DONKEY, 1, 1, 1));
