	...
	protected SunflowerPlainsBiome() {
		super(
			new Biome.Builder()
				...
				.setCategory(Biome.Category.PLAINS)
				.setDepth(0.125F)
				.setScale(0.05F)
				.setTemperature(0.8F)
				.setDownfall(0.4F)
		...
		this.method_16432(
			...
			method_16433(class_3844.field_19164, new class_3840(Blocks.TALL_GRASS.getDefaultState()), field_17610, new class_3832(-0.8, 0, 7))
		);
		this.method_16432(
			class_3801.class_3803.VEGETAL_DECORATION,
			method_16433(class_3844.field_19164, new class_3840(Blocks.SUNFLOWER.getDefaultState()), field_17607, new class_3935(10))
		);
		this.method_16432(
		...
		this.method_16432(
			...
			method_16433(
				...
				new class_3880(
					new class_3844[]{class_3844.field_19195},
					new class_3845[]{class_3845.field_19203},
					new float[]{0.33333334F},
					class_3844.field_19123,
					class_3845.field_19203
				),
				field_17617,
				new class_3937(0, 0.05F, 1)
			)
		);
		this.method_16432(class_3801.class_3803.VEGETAL_DECORATION, method_16434(class_3844.field_19129, field_17610, new class_3832(-0.8, 15, 4)));
		this.method_16432(
			class_3801.class_3803.VEGETAL_DECORATION,
			method_16433(class_3844.field_19133, new class_3909(Blocks.GRASS.getDefaultState()), field_17611, new class_3832(-0.8, 5, 10))
		);
		...
		this.method_16425(EntityCategory.PASSIVE, new Biome.SpawnEntry(EntityType.HORSE, 5, 2, 6));
		this.method_16425(EntityCategory.PASSIVE, new Biome.SpawnEntry(EntityType.DONKEY, 1, 1, 3));
