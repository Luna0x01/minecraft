	...
	public RiverBiome() {
		super(
			new Biome.Builder()
				...
				.setCategory(Biome.Category.RIVER)
				.setDepth(-0.5F)
				.setScale(0.0F)
				.setTemperature(0.5F)
				.setDownfall(0.5F)
		...
		this.method_16432(
			class_3801.class_3803.VEGETAL_DECORATION, method_16433(class_3844.field_19179, new class_3889(48, 0.4), field_17532, class_3830.field_19084)
		);
		this.method_16432(
		...
		this.method_16425(EntityCategory.AQUATIC, new Biome.SpawnEntry(EntityType.SQUID, 2, 1, 4));
		this.method_16425(EntityCategory.AQUATIC, new Biome.SpawnEntry(EntityType.SALMON, 5, 1, 5));
		...
		this.method_16425(EntityCategory.MONSTER, new Biome.SpawnEntry(EntityType.DROWNED, 100, 1, 1));
