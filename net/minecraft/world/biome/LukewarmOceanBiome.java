...
public class LukewarmOceanBiome extends Biome {
	public LukewarmOceanBiome() {
		...
		this.method_16425(EntityCategory.AQUATIC, new Biome.SpawnEntry(EntityType.SQUID, 10, 1, 2));
		this.method_16425(EntityCategory.AQUATIC, new Biome.SpawnEntry(EntityType.COD, 15, 3, 6));
