...
public class WarmOceanBiome extends Biome {
	public WarmOceanBiome() {
		...
		this.addStructureFeature(Feature.OCEAN_RUIN.configure(new OceanRuinFeatureConfig(OceanRuinFeature.BiomeType.field_14532, 0.3F, 0.9F)));
		...
		this.addFeature(
			...
			Feature.field_13555
				...
				.createDecoratedFeature(Decorator.field_14247.configure(new TopSolidHeightmapNoiseBiasedDecoratorConfig(20, 400.0, 0.0, Heightmap.Type.field_13195)))
		);
		DefaultBiomeFeatures.addSeagrass(this);
		this.addFeature(
			GenerationStep.Feature.field_13178,
			Feature.field_13575.configure(new SeaPickleFeatureConfig(20)).createDecoratedFeature(Decorator.field_14258.configure(new ChanceDecoratorConfig(16)))
		);
