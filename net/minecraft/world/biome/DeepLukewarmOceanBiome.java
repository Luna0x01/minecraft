...
import net.minecraft.class_3894;
...
public class DeepLukewarmOceanBiome extends Biome {
	public DeepLukewarmOceanBiome() {
		super(
			new Biome.Builder()
				.setSurfaceBuilder(new SurfaceBuilder<>(field_17594, field_17588))
		...
		this.method_16436(class_3844.field_19191, new class_3874(class_3983.class_3985.WARM, 0.3F, 0.9F));
		this.method_16436(class_3844.field_19190, new class_3872());
		...
		this.method_16432(
			class_3801.class_3803.VEGETAL_DECORATION, method_16433(class_3844.field_19179, new class_3889(80, 0.8), field_17532, class_3830.field_19084)
		);
		this.method_16432(
			class_3801.class_3803.VEGETAL_DECORATION,
			method_16433(
				class_3844.field_19151,
				new class_3894(
				...
				field_17535,
				new class_3933(class_3801.class_3802.LIQUID, 0.1F)
			)
		);
		this.method_16432(
			class_3801.class_3803.VEGETAL_DECORATION, method_16433(class_3844.field_19180, class_3845.field_19203, field_17534, new class_3939(80, 80.0))
		);
		this.method_16432(
		...
		this.method_16425(EntityCategory.AQUATIC, new Biome.SpawnEntry(EntityType.SQUID, 8, 1, 4));
		this.method_16425(EntityCategory.AQUATIC, new Biome.SpawnEntry(EntityType.COD, 8, 3, 6));
		this.method_16425(EntityCategory.AQUATIC, new Biome.SpawnEntry(EntityType.PUFFERFISH, 5, 1, 3));
		this.method_16425(EntityCategory.AQUATIC, new Biome.SpawnEntry(EntityType.TROPICAL_FISH, 25, 8, 8));
		this.method_16425(EntityCategory.AQUATIC, new Biome.SpawnEntry(EntityType.DOLPHIN, 2, 1, 2));
