...
public class BiomeLayers {
	protected static final int WARM_OCEAN_ID = Registry.field_11153.getRawId(Biomes.field_9408);
	protected static final int LUKEWARM_OCEAN_ID = Registry.field_11153.getRawId(Biomes.field_9441);
	protected static final int OCEAN_ID = Registry.field_11153.getRawId(Biomes.field_9423);
	protected static final int COLD_OCEAN_ID = Registry.field_11153.getRawId(Biomes.field_9467);
	protected static final int FROZEN_OCEAN_ID = Registry.field_11153.getRawId(Biomes.field_9435);
	protected static final int DEEP_WARM_OCEAN_ID = Registry.field_11153.getRawId(Biomes.field_9448);
	protected static final int DEEP_LUKEWARM_OCEAN_ID = Registry.field_11153.getRawId(Biomes.field_9439);
	protected static final int DEEP_OCEAN_ID = Registry.field_11153.getRawId(Biomes.field_9446);
	protected static final int DEEP_COLD_OCEAN_ID = Registry.field_11153.getRawId(Biomes.field_9470);
	protected static final int DEEP_FROZEN_OCEAN_ID = Registry.field_11153.getRawId(Biomes.field_9418);
	...
	public static <T extends LayerSampler, C extends LayerSampleContext<T>> LayerFactory<T> build(
		...
		return ApplyOceanTemperatureLayer.field_16121.create((LayerSampleContext<T>)longFunction.apply(100L), layerFactory4, layerFactory2);
	}
	...
	public static boolean areSimilar(int i, int j) {
		if (i == j) {
			...
			Biome biome2 = Registry.field_11153.get(j);
