...
public enum AddEdgeBiomesLayer implements CrossSamplingLayer {
	...
	private static final int BEACH_ID = Registry.field_11153.getRawId(Biomes.field_9434);
	private static final int SNOWY_BEACH_ID = Registry.field_11153.getRawId(Biomes.field_9478);
	...
	private static final int JUNGLE_EDGE_ID = Registry.field_11153.getRawId(Biomes.field_9474);
	...
	private static final int BADLANDS_PLATEAU_ID = Registry.field_11153.getRawId(Biomes.field_9433);
	private static final int ERODED_BADLANDS_ID = Registry.field_11153.getRawId(Biomes.field_9443);
	private static final int MODIFIED_WOODED_BADLANDS_PLATEAU_ID = Registry.field_11153.getRawId(Biomes.field_9413);
	private static final int MODIFIED_BADLANDS_PLATEAU_ID = Registry.field_11153.getRawId(Biomes.field_9406);
	...
	private static final int MOUNTAIN_EDGE_ID = Registry.field_11153.getRawId(Biomes.field_9464);
	private static final int STONE_SHORE_ID = Registry.field_11153.getRawId(Biomes.field_9419);
	...
	public int sample(LayerRandomnessSource layerRandomnessSource, int i, int j, int k, int l, int m) {
		Biome biome = Registry.field_11153.get(m);
	...
	private static boolean isWooded(int i) {
		return Registry.field_11153.get(i) != null && Registry.field_11153.get(i).getCategory() == Biome.Category.field_9358
			? true
