...
public final class JungleHillsBiome extends Biome {
	public JungleHillsBiome() {
		...
		this.addSpawn(EntityCategory.field_6294, new Biome.SpawnEntry(EntityType.field_6104, 10, 1, 1));
		this.addSpawn(EntityCategory.field_6294, new Biome.SpawnEntry(EntityType.field_6146, 1, 1, 2));
		this.addSpawn(EntityCategory.field_6294, new Biome.SpawnEntry(EntityType.field_6132, 10, 4, 4));
