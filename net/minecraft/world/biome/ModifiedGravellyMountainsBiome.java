...
public final class ModifiedGravellyMountainsBiome extends Biome {
	protected ModifiedGravellyMountainsBiome() {
		super(
			new Biome.Builder()
				.setSurfaceBuilder(new SurfaceBuilder<>(field_17597, field_17582))
				.setPrecipitation(Biome.Precipitation.RAIN)
				.setCategory(Biome.Category.EXTREME_HILLS)
				.setDepth(1.0F)
				.setScale(0.5F)
				.setTemperature(0.2F)
				.setDownfall(0.3F)
		...
		this.method_16432(
			...
			method_16433(
				...
				new class_3880(
					new class_3844[]{class_3844.field_19121, class_3844.field_19195},
		...
		this.method_16432(
			class_3801.class_3803.UNDERGROUND_ORES,
			method_16433(
				class_3844.field_19173, new class_3885(BlockPredicate.create(Blocks.STONE), Blocks.EMERALD_ORE.getDefaultState()), field_17539, class_3830.field_19084
			)
		);
		this.method_16432(
			class_3801.class_3803.UNDERGROUND_DECORATION,
			method_16433(
				class_3844.field_19168, new class_3875(class_3875.field_19226, Blocks.INFESTED_STONE.getDefaultState(), 9), field_17618, new class_3831(7, 0, 0, 64)
			)
		);
		this.method_16432(
		...
		this.method_16425(EntityCategory.PASSIVE, new Biome.SpawnEntry(EntityType.LLAMA, 5, 4, 6));
