...
import net.minecraft.class_3889;
...
public final class SwampBiome extends Biome {
	protected SwampBiome() {
		super(
			new Biome.Builder()
				.setSurfaceBuilder(new SurfaceBuilder<>(field_17599, field_17582))
				.setPrecipitation(Biome.Precipitation.RAIN)
				.setCategory(Biome.Category.SWAMP)
				.setDepth(-0.2F)
				.setScale(0.1F)
				.setTemperature(0.8F)
				.setDownfall(0.9F)
		...
		this.method_16436(class_3844.field_19188, new class_3905());
		...
		this.method_16432(
			class_3801.class_3803.VEGETAL_DECORATION, method_16433(class_3844.field_19122, class_3845.field_19203, field_17617, new class_3937(2, 0.1F, 1))
		);
		this.method_16432(class_3801.class_3803.VEGETAL_DECORATION, method_16434(class_3844.field_19130, field_17607, new class_3935(1)));
		this.method_16432(
			class_3801.class_3803.VEGETAL_DECORATION,
			method_16433(class_3844.field_19133, new class_3909(Blocks.GRASS.getDefaultState()), field_17608, new class_3935(5))
		);
		this.method_16432(class_3801.class_3803.VEGETAL_DECORATION, method_16433(class_3844.field_19136, class_3845.field_19203, field_17608, new class_3935(1)));
		this.method_16432(class_3801.class_3803.VEGETAL_DECORATION, method_16433(class_3844.field_19157, class_3845.field_19203, field_17608, new class_3935(4)));
		this.method_16432(
			class_3801.class_3803.VEGETAL_DECORATION, method_16433(class_3844.field_19162, new class_3819(Blocks.BROWN_MUSHROOM), field_17623, new class_3936(8, 0.25F))
		);
		this.method_16432(
			class_3801.class_3803.VEGETAL_DECORATION, method_16433(class_3844.field_19162, new class_3819(Blocks.RED_MUSHROOM), field_17624, new class_3936(8, 0.125F))
		);
		this.method_16432(
		...
		this.method_16432(class_3801.class_3803.VEGETAL_DECORATION, method_16433(class_3844.field_19146, class_3845.field_19203, field_17608, new class_3935(20)));
		...
		this.method_16432(
			class_3801.class_3803.VEGETAL_DECORATION, method_16433(class_3844.field_19179, new class_3889(64, 0.6), field_17532, class_3830.field_19084)
		);
		...
		this.method_16425(EntityCategory.MONSTER, new Biome.SpawnEntry(EntityType.SLIME, 1, 1, 1));
	}
