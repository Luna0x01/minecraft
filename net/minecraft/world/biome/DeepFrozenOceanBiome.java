...
public class DeepFrozenOceanBiome extends Biome {
	protected static final PerlinNoiseGenerator field_17687 = new PerlinNoiseGenerator(new Random(3456L), 3);
	...
	public float getTemperature(BlockPos pos) {
		...
		double d = field_17687.noise((double)pos.getX() * 0.05, (double)pos.getZ() * 0.05);
