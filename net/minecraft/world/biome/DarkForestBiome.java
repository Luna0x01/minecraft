			...
			Feature.field_13593
				.configure(
					new RandomFeatureConfig(
						ImmutableList.of(
							Feature.field_13531.configure(DefaultBiomeFeatures.HUGE_BROWN_MUSHROOM_CONFIG).withChance(0.025F),
							Feature.field_13571.configure(DefaultBiomeFeatures.HUGE_RED_MUSHROOM_CONFIG).withChance(0.05F),
