...
public final class IceBiome extends Biome {
	public IceBiome() {
		super(
			new Biome.Builder()
				.setSurfaceBuilder(
					new SurfaceBuilder<>(field_17594, new class_4013(Blocks.SNOW_BLOCK.getDefaultState(), Blocks.DIRT.getDefaultState(), Blocks.GRAVEL.getDefaultState()))
				)
				.setPrecipitation(Biome.Precipitation.SNOW)
				.setCategory(Biome.Category.ICY)
				.setDepth(0.425F)
				.setScale(0.45000002F)
				.setTemperature(0.0F)
				.setDownfall(0.5F)
				.setWaterColor(4159204)
				.setWaterFogColor(329011)
				.setParent("snowy_tundra")
		);
		...
		this.method_16432(class_3801.class_3803.SURFACE_STRUCTURES, method_16433(class_3844.field_19142, class_3845.field_19203, field_17605, new class_3935(3)));
		this.method_16432(class_3801.class_3803.SURFACE_STRUCTURES, method_16433(class_3844.field_19166, new class_3846(2), field_17605, new class_3935(2)));
		this.method_16432(
		...
		this.method_16432(
			class_3801.class_3803.VEGETAL_DECORATION, method_16433(class_3844.field_19121, class_3845.field_19203, field_17617, new class_3937(0, 0.1F, 1))
		);
		...
		this.method_16425(EntityCategory.PASSIVE, new Biome.SpawnEntry(EntityType.RABBIT, 10, 2, 3));
		...
		this.method_16425(EntityCategory.MONSTER, new Biome.SpawnEntry(EntityType.SKELETON, 20, 4, 4));
		this.method_16425(EntityCategory.MONSTER, new Biome.SpawnEntry(EntityType.STRAY, 80, 4, 4));
	}
