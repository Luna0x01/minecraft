	...
	public BeachBiome() {
		super(
			new Biome.Builder()
				...
				.setCategory(Biome.Category.BEACH)
				.setDepth(0.0F)
				.setScale(0.025F)
				.setTemperature(0.8F)
				.setDownfall(0.4F)
		...
		this.method_16436(class_3844.field_19194, new class_3816(0.01F));
		this.method_16436(class_3844.field_19187, new class_3890(true));
		...
		this.method_16425(EntityCategory.PASSIVE, new Biome.SpawnEntry(EntityType.TURTLE, 5, 2, 5));
