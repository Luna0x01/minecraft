...
public final class GiantTreeTaigaBiome extends Biome {
	public GiantTreeTaigaBiome() {
		super(
			new Biome.Builder()
				.setSurfaceBuilder(new SurfaceBuilder<>(field_17598, field_17582))
				.setPrecipitation(Biome.Precipitation.RAIN)
				.setCategory(Biome.Category.TAIGA)
				.setDepth(0.2F)
				.setScale(0.2F)
				.setTemperature(0.3F)
				.setDownfall(0.8F)
		...
		this.method_16432(
			class_3801.class_3803.LOCAL_MODIFICATIONS, method_16433(class_3844.field_19161, new class_3813(Blocks.MOSSY_COBBLESTONE, 0), field_17536, new class_3935(3))
		);
		this.method_16432(
			class_3801.class_3803.VEGETAL_DECORATION,
			method_16433(class_3844.field_19164, new class_3840(Blocks.LARGE_FERN.getDefaultState()), field_17607, new class_3935(7))
		);
		this.method_16432(
		...
		this.method_16432(
			...
			method_16433(
				...
				new class_3880(
					new class_3844[]{class_3844.field_19126, class_3844.field_19125, class_3844.field_19200},
					...
					class_3844.field_19121,
					class_3845.field_19203
				),
				field_17617,
				new class_3937(10, 0.1F, 1)
			)
		);
		...
		this.method_16432(class_3801.class_3803.VEGETAL_DECORATION, method_16433(class_3844.field_19132, class_3845.field_19203, field_17608, new class_3935(7)));
		...
		this.method_16432(
			class_3801.class_3803.VEGETAL_DECORATION, method_16433(class_3844.field_19162, new class_3819(Blocks.BROWN_MUSHROOM), field_17623, new class_3936(3, 0.25F))
		);
		this.method_16432(
			class_3801.class_3803.VEGETAL_DECORATION, method_16433(class_3844.field_19162, new class_3819(Blocks.RED_MUSHROOM), field_17624, new class_3936(3, 0.125F))
		);
		this.method_16432(
		...
		this.method_16425(EntityCategory.PASSIVE, new Biome.SpawnEntry(EntityType.WOLF, 8, 4, 4));
		...
		this.method_16425(EntityCategory.MONSTER, new Biome.SpawnEntry(EntityType.ZOMBIE, 100, 4, 4));
		this.method_16425(EntityCategory.MONSTER, new Biome.SpawnEntry(EntityType.SKELETON, 100, 4, 4));
		this.method_16425(EntityCategory.MONSTER, new Biome.SpawnEntry(EntityType.ZOMBIE_VILLAGER, 25, 1, 1));
