...
import net.minecraft.class_3878;
...
public final class MushroomFieldShoreBiome extends Biome {
	public MushroomFieldShoreBiome() {
		super(
			new Biome.Builder()
				.setSurfaceBuilder(new SurfaceBuilder<>(field_17594, field_17591))
				.setPrecipitation(Biome.Precipitation.RAIN)
				.setCategory(Biome.Category.MUSHROOM)
				.setDepth(0.0F)
				.setScale(0.025F)
				.setTemperature(0.9F)
				.setDownfall(1.0F)
		...
		this.method_16432(
			...
			method_16433(
				class_3844.field_19172,
				new class_3878(class_3844.field_19140, class_3845.field_19203, class_3844.field_19141, class_3845.field_19203),
				field_17605,
				new class_3935(1)
			)
		);
		...
		this.method_16425(EntityCategory.PASSIVE, new Biome.SpawnEntry(EntityType.MOOSHROOM, 8, 4, 8));
