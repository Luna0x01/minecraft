...
public class DefaultBiomeFeatures {
	...
	public static void addDefaultStructures(Biome biome) {
		biome.addFeature(
			...
			Biome.configureFeature(
				Feature.MINESHAFT, new MineshaftFeatureConfig(0.004F, MineshaftFeature.Type.field_13692), Decorator.field_14250, DecoratorConfig.DEFAULT
			)
		);
		biome.addFeature(
			GenerationStep.Feature.field_13173,
			Biome.configureFeature(Feature.PILLAGER_OUTPOST, new PillagerOutpostFeatureConfig(0.004), Decorator.field_14250, DecoratorConfig.DEFAULT)
		);
		biome.addFeature(
			GenerationStep.Feature.field_13172, Biome.configureFeature(Feature.STRONGHOLD, FeatureConfig.DEFAULT, Decorator.field_14250, DecoratorConfig.DEFAULT)
		);
		biome.addFeature(
			GenerationStep.Feature.field_13173, Biome.configureFeature(Feature.SWAMP_HUT, FeatureConfig.DEFAULT, Decorator.field_14250, DecoratorConfig.DEFAULT)
		);
		biome.addFeature(
			GenerationStep.Feature.field_13173, Biome.configureFeature(Feature.DESERT_PYRAMID, FeatureConfig.DEFAULT, Decorator.field_14250, DecoratorConfig.DEFAULT)
		);
		biome.addFeature(
			GenerationStep.Feature.field_13173, Biome.configureFeature(Feature.JUNGLE_TEMPLE, FeatureConfig.DEFAULT, Decorator.field_14250, DecoratorConfig.DEFAULT)
		);
		biome.addFeature(
			GenerationStep.Feature.field_13173, Biome.configureFeature(Feature.IGLOO, FeatureConfig.DEFAULT, Decorator.field_14250, DecoratorConfig.DEFAULT)
		);
		biome.addFeature(
			GenerationStep.Feature.field_13173,
			Biome.configureFeature(Feature.SHIPWRECK, new ShipwreckFeatureConfig(false), Decorator.field_14250, DecoratorConfig.DEFAULT)
		);
		biome.addFeature(
			GenerationStep.Feature.field_13173, Biome.configureFeature(Feature.OCEAN_MONUMENT, FeatureConfig.DEFAULT, Decorator.field_14250, DecoratorConfig.DEFAULT)
		);
		biome.addFeature(
			GenerationStep.Feature.field_13173, Biome.configureFeature(Feature.WOODLAND_MANSION, FeatureConfig.DEFAULT, Decorator.field_14250, DecoratorConfig.DEFAULT)
		);
		biome.addFeature(
			GenerationStep.Feature.field_13173,
			Biome.configureFeature(
				Feature.OCEAN_RUIN, new OceanRuinFeatureConfig(OceanRuinFeature.BiomeType.field_14528, 0.3F, 0.9F), Decorator.field_14250, DecoratorConfig.DEFAULT
			)
		);
		biome.addFeature(
			GenerationStep.Feature.field_13172,
			Biome.configureFeature(Feature.BURIED_TREASURE, new BuriedTreasureFeatureConfig(0.01F), Decorator.field_14250, DecoratorConfig.DEFAULT)
		);
		biome.addFeature(
			GenerationStep.Feature.field_13173,
			Biome.configureFeature(Feature.VILLAGE, new VillageFeatureConfig("village/plains/town_centers", 6), Decorator.field_14250, DecoratorConfig.DEFAULT)
		);
	}
	...
	public static void addDungeons(Biome biome) {
		biome.addFeature(
			GenerationStep.Feature.field_13172, Biome.configureFeature(Feature.field_13579, FeatureConfig.DEFAULT, Decorator.field_14265, new DungeonDecoratorConfig(8))
		);
	}
	...
	public static void addMineables(Biome biome) {
		biome.addFeature(
			...
			Biome.configureFeature(
				Feature.field_13517,
				new OreFeatureConfig(OreFeatureConfig.Target.field_13730, Blocks.field_10566.getDefaultState(), 33),
		...
		biome.addFeature(
			...
			Biome.configureFeature(
				Feature.field_13517,
				new OreFeatureConfig(OreFeatureConfig.Target.field_13730, Blocks.field_10255.getDefaultState(), 33),
				Decorator.field_14241,
		...
		biome.addFeature(
			...
			Biome.configureFeature(
				Feature.field_13517,
				new OreFeatureConfig(OreFeatureConfig.Target.field_13730, Blocks.field_10474.getDefaultState(), 33),
				Decorator.field_14241,
		...
		biome.addFeature(
			...
			Biome.configureFeature(
				Feature.field_13517,
				new OreFeatureConfig(OreFeatureConfig.Target.field_13730, Blocks.field_10508.getDefaultState(), 33),
				Decorator.field_14241,
				new RangeDecoratorConfig(10, 0, 0, 80)
			)
		);
		biome.addFeature(
			...
			Biome.configureFeature(
				Feature.field_13517,
				new OreFeatureConfig(OreFeatureConfig.Target.field_13730, Blocks.field_10115.getDefaultState(), 33),
				Decorator.field_14241,
				new RangeDecoratorConfig(10, 0, 0, 80)
			)
		);
	...
	public static void addDefaultOres(Biome biome) {
		biome.addFeature(
			...
			Biome.configureFeature(
				Feature.field_13517,
				new OreFeatureConfig(OreFeatureConfig.Target.field_13730, Blocks.field_10418.getDefaultState(), 17),
				Decorator.field_14241,
		...
		biome.addFeature(
			...
			Biome.configureFeature(
				Feature.field_13517,
				new OreFeatureConfig(OreFeatureConfig.Target.field_13730, Blocks.field_10212.getDefaultState(), 9),
				Decorator.field_14241,
		...
		biome.addFeature(
			...
			Biome.configureFeature(
				Feature.field_13517,
				new OreFeatureConfig(OreFeatureConfig.Target.field_13730, Blocks.field_10571.getDefaultState(), 9),
				Decorator.field_14241,
		...
		biome.addFeature(
			...
			Biome.configureFeature(
				Feature.field_13517,
				new OreFeatureConfig(OreFeatureConfig.Target.field_13730, Blocks.field_10080.getDefaultState(), 8),
				Decorator.field_14241,
		...
		biome.addFeature(
			...
			Biome.configureFeature(
				Feature.field_13517,
				new OreFeatureConfig(OreFeatureConfig.Target.field_13730, Blocks.field_10442.getDefaultState(), 8),
				Decorator.field_14241,
		...
		biome.addFeature(
			...
			Biome.configureFeature(
				Feature.field_13517,
				new OreFeatureConfig(OreFeatureConfig.Target.field_13730, Blocks.field_10090.getDefaultState(), 7),
	...
	public static void addInfestedStone(Biome biome) {
		biome.addFeature(
			...
			Biome.configureFeature(
				Feature.field_13517,
				new OreFeatureConfig(OreFeatureConfig.Target.field_13730, Blocks.field_10277.getDefaultState(), 9),
				Decorator.field_14241,
	...
	public static void addDefaultDisks(Biome biome) {
		biome.addFeature(
			...
			Biome.configureFeature(
				...
				new DiskFeatureConfig(
					Blocks.field_10102.getDefaultState(),
					7,
					2,
					Lists.newArrayList(new BlockState[]{Blocks.field_10566.getDefaultState(), Blocks.field_10219.getDefaultState()})
				),
		...
		biome.addFeature(
			...
			Biome.configureFeature(
				Feature.field_13509,
				new DiskFeatureConfig(
					Blocks.field_10460.getDefaultState(),
					4,
					1,
					Lists.newArrayList(new BlockState[]{Blocks.field_10566.getDefaultState(), Blocks.field_10460.getDefaultState()})
				),
				Decorator.field_14245,
		...
		biome.addFeature(
			...
			Biome.configureFeature(
				Feature.field_13509,
				new DiskFeatureConfig(
					Blocks.field_10255.getDefaultState(),
					6,
					2,
					Lists.newArrayList(new BlockState[]{Blocks.field_10566.getDefaultState(), Blocks.field_10219.getDefaultState()})
				),
	...
	public static void addSweetBerryBushesSnowy(Biome biome) {
		biome.addFeature(
			GenerationStep.Feature.field_13178, Biome.configureFeature(Feature.field_17004, FeatureConfig.DEFAULT, Decorator.field_14263, new ChanceDecoratorConfig(12))
		);
	}

	public static void addSweetBerryBushes(Biome biome) {
		biome.addFeature(
			GenerationStep.Feature.field_13178, Biome.configureFeature(Feature.field_17004, FeatureConfig.DEFAULT, Decorator.field_14240, new CountDecoratorConfig(1))
		);
	}
	...
	public static void addJungleGrass(Biome biome) {
		biome.addFeature(
			GenerationStep.Feature.field_13178, Biome.configureFeature(Feature.field_13590, FeatureConfig.DEFAULT, Decorator.field_14240, new CountDecoratorConfig(25))
		);
	}
	...
	public static void addBadlandsGrass(Biome biome) {
		...
		biome.addFeature(
			GenerationStep.Feature.field_13178, Biome.configureFeature(Feature.field_13548, FeatureConfig.DEFAULT, Decorator.field_14240, new CountDecoratorConfig(20))
		);
	}
	...
	public static void addSwampFeatures(Biome biome) {
		...
		biome.addFeature(
			GenerationStep.Feature.field_13178, Biome.configureFeature(Feature.SWAMP_FLOWER, FeatureConfig.DEFAULT, Decorator.field_14253, new CountDecoratorConfig(1))
		);
		biome.addFeature(
			GenerationStep.Feature.field_13178,
			Biome.configureFeature(Feature.field_13511, new GrassFeatureConfig(Blocks.field_10479.getDefaultState()), Decorator.field_14240, new CountDecoratorConfig(5))
		...
		biome.addFeature(
			GenerationStep.Feature.field_13178, Biome.configureFeature(Feature.field_13548, FeatureConfig.DEFAULT, Decorator.field_14240, new CountDecoratorConfig(1))
		);
		biome.addFeature(
			GenerationStep.Feature.field_13178, Biome.configureFeature(Feature.field_13542, FeatureConfig.DEFAULT, Decorator.field_14240, new CountDecoratorConfig(4))
		);
		biome.addFeature(
			GenerationStep.Feature.field_13178,
			Biome.configureFeature(
	...
	public static void addDesertDeadBushes(Biome biome) {
		biome.addFeature(
			GenerationStep.Feature.field_13178, Biome.configureFeature(Feature.field_13548, FeatureConfig.DEFAULT, Decorator.field_14240, new CountDecoratorConfig(2))
		);
	}

	public static void addGiantTaigaGrass(Biome biome) {
		biome.addFeature(
			GenerationStep.Feature.field_13178, Biome.configureFeature(Feature.field_13521, FeatureConfig.DEFAULT, Decorator.field_14240, new CountDecoratorConfig(7))
		);
		biome.addFeature(
			GenerationStep.Feature.field_13178, Biome.configureFeature(Feature.field_13548, FeatureConfig.DEFAULT, Decorator.field_14240, new CountDecoratorConfig(1))
		);
	...
	public static void addTaigaGrass(Biome biome) {
		biome.addFeature(
			GenerationStep.Feature.field_13178, Biome.configureFeature(Feature.field_13521, FeatureConfig.DEFAULT, Decorator.field_14240, new CountDecoratorConfig(1))
		);
		biome.addFeature(
			GenerationStep.Feature.field_13178,
			Biome.configureFeature(
	...
	public static void addDefaultVegetation(Biome biome) {
		biome.addFeature(
			GenerationStep.Feature.field_13178, Biome.configureFeature(Feature.field_13583, FeatureConfig.DEFAULT, Decorator.field_14240, new CountDecoratorConfig(10))
		);
		biome.addFeature(
			GenerationStep.Feature.field_13178, Biome.configureFeature(Feature.field_13524, FeatureConfig.DEFAULT, Decorator.field_14263, new ChanceDecoratorConfig(32))
		);
	}

	public static void addBadlandsVegetation(Biome biome) {
		biome.addFeature(
			GenerationStep.Feature.field_13178, Biome.configureFeature(Feature.field_13583, FeatureConfig.DEFAULT, Decorator.field_14240, new CountDecoratorConfig(13))
		);
		biome.addFeature(
			GenerationStep.Feature.field_13178, Biome.configureFeature(Feature.field_13524, FeatureConfig.DEFAULT, Decorator.field_14263, new ChanceDecoratorConfig(32))
		);
		biome.addFeature(
			GenerationStep.Feature.field_13178, Biome.configureFeature(Feature.field_13554, FeatureConfig.DEFAULT, Decorator.field_14240, new CountDecoratorConfig(5))
		);
	}

	public static void addJungleVegetation(Biome biome) {
		biome.addFeature(
			GenerationStep.Feature.field_13178, Biome.configureFeature(Feature.field_13534, FeatureConfig.DEFAULT, Decorator.field_14240, new CountDecoratorConfig(1))
		);
		biome.addFeature(
			GenerationStep.Feature.field_13178, Biome.configureFeature(Feature.field_13559, FeatureConfig.DEFAULT, Decorator.field_14249, new CountDecoratorConfig(50))
		);
	}

	public static void addDesertVegetation(Biome biome) {
		biome.addFeature(
			GenerationStep.Feature.field_13178, Biome.configureFeature(Feature.field_13583, FeatureConfig.DEFAULT, Decorator.field_14240, new CountDecoratorConfig(60))
		);
		biome.addFeature(
			GenerationStep.Feature.field_13178, Biome.configureFeature(Feature.field_13524, FeatureConfig.DEFAULT, Decorator.field_14263, new ChanceDecoratorConfig(32))
		);
		biome.addFeature(
			GenerationStep.Feature.field_13178, Biome.configureFeature(Feature.field_13554, FeatureConfig.DEFAULT, Decorator.field_14240, new CountDecoratorConfig(10))
		);
	}

	public static void addSwampVegetation(Biome biome) {
		biome.addFeature(
			GenerationStep.Feature.field_13178, Biome.configureFeature(Feature.field_13583, FeatureConfig.DEFAULT, Decorator.field_14240, new CountDecoratorConfig(20))
		);
		biome.addFeature(
			GenerationStep.Feature.field_13178, Biome.configureFeature(Feature.field_13524, FeatureConfig.DEFAULT, Decorator.field_14263, new ChanceDecoratorConfig(32))
		);
	...
	public static void addDesertFeatures(Biome biome) {
		...
		biome.addFeature(
			GenerationStep.Feature.field_13177, Biome.configureFeature(Feature.field_13516, FeatureConfig.DEFAULT, Decorator.field_14246, new ChanceDecoratorConfig(64))
		);
	}
	...
	public static void addSeagrassOnStone(Biome biome) {
		biome.addFeature(
			...
			Biome.configureFeature(
				...
				new CarvingMaskDecoratorConfig(GenerationStep.Carver.field_13166, 0.1F)
			)
		);
	}
	...
	public static void addFrozenTopLayer(Biome biome) {
		biome.addFeature(
			GenerationStep.Feature.field_13179, Biome.configureFeature(Feature.field_13539, FeatureConfig.DEFAULT, Decorator.field_14250, DecoratorConfig.DEFAULT)
		);
	}

	public static void method_20826(Biome biome) {
		biome.addFeature(
			GenerationStep.Feature.field_13173, Biome.configureFeature(Feature.END_CITY, FeatureConfig.DEFAULT, Decorator.field_14250, DecoratorConfig.DEFAULT)
		);
	}
}
