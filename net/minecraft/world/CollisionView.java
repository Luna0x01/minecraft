...
public interface CollisionView extends BlockView {
	...
	default Stream<VoxelShape> getCollisions(@Nullable Entity entity, Box box, Set<Entity> set) {
		return Streams.concat(new Stream[]{this.getBlockCollisions(entity, box), this.getEntityCollisions(entity, box, set)});
	}
				...
				while (cuboidBlockIterator.step()) {
					...
					if (l != 3) {
						...
						if (blockView != null) {
							...
							if ((l != 1 || blockState.exceedsCube()) && (l != 2 || blockState.getBlock() == Blocks.field_10008)) {
