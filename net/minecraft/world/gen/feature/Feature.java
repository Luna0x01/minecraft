...
public abstract class Feature<FC extends FeatureConfig> {
	...
	public static final Feature<HugeMushroomFeatureConfig> field_13571 = register(
	...
	public static final Feature<SingleStateFeatureConfig> field_13544 = register("iceberg", new IcebergFeature(SingleStateFeatureConfig::deserialize));
	...
	public static final Feature<SingleStateFeatureConfig> field_13573 = register("lake", new LakeFeature(SingleStateFeatureConfig::deserialize));
	...
	private static <C extends FeatureConfig, F extends Feature<C>> F register(String string, F feature) {
		return Registry.register(Registry.field_11138, string, feature);
	}
