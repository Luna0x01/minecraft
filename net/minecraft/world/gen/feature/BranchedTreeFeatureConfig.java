...
public class BranchedTreeFeatureConfig extends TreeFeatureConfig {
	...
	public <T> Dynamic<T> serialize(DynamicOps<T> dynamicOps) {
		...
		builder.put(dynamicOps.createString("foliage_placer"), this.foliagePlacer.serialize(dynamicOps))
			...
			.put(dynamicOps.createString("ignore_vines"), dynamicOps.createBoolean(this.noVines));
	...
	public static <T> BranchedTreeFeatureConfig deserialize(Dynamic<T> dynamic) {
		...
		FoliagePlacerType<?> foliagePlacerType = Registry.field_21447
	...
	public static class Builder extends TreeFeatureConfig.Builder {
		...
		public BranchedTreeFeatureConfig.Builder treeDecorators(List<TreeDecorator> list) {
		...
		public BranchedTreeFeatureConfig.Builder heightRandA(int i) {
			this.heightRandA = i;
			return this;
		}

		public BranchedTreeFeatureConfig.Builder heightRandB(int i) {
			this.heightRandB = i;
			return this;
		}

		public BranchedTreeFeatureConfig.Builder trunkHeight(int i) {
			this.trunkHeight = i;
			return this;
		}

		public BranchedTreeFeatureConfig.Builder trunkHeightRandom(int i) {
			this.trunkHeightRandom = i;
			return this;
		}

		public BranchedTreeFeatureConfig.Builder trunkTopOffset(int i) {
			this.trunkTopOffset = i;
			return this;
		}

		public BranchedTreeFeatureConfig.Builder trunkTopOffsetRandom(int i) {
			this.trunkTopOffsetRandom = i;
			return this;
		}

		public BranchedTreeFeatureConfig.Builder foliageHeight(int i) {
			this.foliageHeight = i;
			return this;
		}

		public BranchedTreeFeatureConfig.Builder foliageHeightRandom(int i) {
			this.foliageHeightRandom = i;
			return this;
		}

		public BranchedTreeFeatureConfig.Builder maxWaterDepth(int i) {
