...
public class FossilFeature extends Feature<FossilFeatureConfig> {
	...
	public boolean generate(FeatureContext<FossilFeatureConfig> context) {
		...
		int o = Math.max(l - 15 - random.nextInt(10), structureWorldAccess.getBottomY() + 10);
		BlockPos blockPos2 = structure.offsetByTransformedSize(blockPos.add(j, 0, k).withY(o), BlockMirror.NONE, blockRotation);
