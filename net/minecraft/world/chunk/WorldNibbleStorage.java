...
public abstract class WorldNibbleStorage<M extends WorldNibbleStorage<M>> {
	...
	public void cloneChunkData(long l) {
		this.arraysByChunk.put(l, ((ChunkNibbleArray)this.arraysByChunk.get(l)).copy());
		this.clearCache();
	}
	...
	public ChunkNibbleArray getDataForChunk(long l) {
		...
		ChunkNibbleArray chunkNibbleArray = (ChunkNibbleArray)this.arraysByChunk.get(l);
	...
	public ChunkNibbleArray removeChunk(long l) {
		return (ChunkNibbleArray)this.arraysByChunk.remove(l);
	}
