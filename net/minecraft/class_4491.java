...
public class class_4491 extends DataFix {
	private static final Map<String, String> field_22264 = ImmutableMap.builder()
	...
	public class_4491(Schema schema, boolean bl) {
		super(schema, bl);
	}
	...
	protected TypeRewriteRule makeRule() {
		return this.fixTypeEverywhereTyped(
			"AdvancementsFix",
			this.getInputSchema().getType(class_3402.field_16590),
			typed -> typed.update(DSL.remainderFinder(), dynamic -> dynamic.updateMapValues(pair -> {
						...
						return pair.mapFirst(dynamic2 -> dynamic.createString((String)field_22264.getOrDefault(string, string)));
					}))
		);
	}
}
