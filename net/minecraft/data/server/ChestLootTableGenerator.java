			...
			LootTable.builder()
				.withPool(
					LootPool.builder()
						...
						.withEntry(ItemEntry.builder(Items.field_8529).setWeight(10).withFunction(EnchantRandomlyLootFunction.builder()))
			...
			LootTable.builder()
				.withPool(
					LootPool.builder()
						...
						.withEntry(ItemEntry.builder(Items.field_8529).setWeight(20).withFunction(EnchantRandomlyLootFunction.builder()))
						.withEntry(ItemEntry.builder(Items.field_8463).setWeight(20))
			...
			LootTable.builder()
				...
				.withPool(
					LootPool.builder()
						...
						.withEntry(ItemEntry.builder(Items.field_8529).setWeight(1).withFunction(EnchantRandomlyLootFunction.builder()))
				)
		);
		biConsumer.accept(
			...
			LootTable.builder()
				.withPool(
					LootPool.builder()
						...
						.withEntry(ItemEntry.builder(Items.field_8267).setWeight(3).withFunction(EnchantRandomlyLootFunction.builder()))
						.withEntry(ItemEntry.builder(Items.field_8577).setWeight(3).withFunction(EnchantRandomlyLootFunction.builder()))
						.withEntry(ItemEntry.builder(Items.field_8570).setWeight(3).withFunction(EnchantRandomlyLootFunction.builder()))
						.withEntry(ItemEntry.builder(Items.field_8370).setWeight(3).withFunction(EnchantRandomlyLootFunction.builder()))
				)
		);
		biConsumer.accept(
			...
			LootTable.builder()
				...
				.withPool(
					LootPool.builder()
						.withRolls(ConstantLootTableRange.create(1))
						.withEntry(ItemEntry.builder(Items.field_8463))
						.withEntry(ItemEntry.builder(Items.field_8529).setWeight(5).withFunction(EnchantRandomlyLootFunction.builder()))
						.withEntry(ItemEntry.builder(Items.field_8577))
						.withEntry(ItemEntry.builder(Items.field_8862))
						.withEntry(ItemEntry.builder(Items.field_8378).setWeight(5).withFunction(EnchantRandomlyLootFunction.builder()))
						.withEntry(
							ItemEntry.builder(Items.field_8895)
								.setWeight(10)
								.withFunction(
			...
			LootTable.builder()
				.withPool(
					LootPool.builder()
						...
						.withEntry(ItemEntry.builder(Items.field_8600).setWeight(5).withFunction(SetCountLootFunction.builder(UniformLootTableRange.between(1.0F, 2.0F))))
				)
		);
		biConsumer.accept(
