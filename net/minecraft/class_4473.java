...
public interface class_4473 {
	...
	class_4473 DEFAULT = NumberFormat.getIntegerInstance(Locale.US)::format;
	class_4473 DIVIDE_BY_TEN = i -> DECIMAL_FORMAT.format((double)i * 0.1);
	class_4473 DISTANCE = i -> {
