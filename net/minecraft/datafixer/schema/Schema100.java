...
public class Schema100 extends Schema {
	...
	protected static void targetEntity(Schema schema, Map<String, Supplier<TypeTemplate>> map, String string) {
		schema.register(map, string, () -> targetItems(schema));
	}
	...
	public Map<String, Supplier<TypeTemplate>> registerEntities(Schema schema) {
		...
		schema.register(map, "Enderman", string -> DSL.optionalFields("carried", TypeReferences.BLOCK_NAME.in(schema), targetItems(schema)));
