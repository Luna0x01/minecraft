...
public class Schema1460 extends IdentifierNormalizingSchema {
	...
	public Map<String, Supplier<TypeTemplate>> registerEntities(Schema schema) {
		...
		schema.register(map, "minecraft:arrow", string -> DSL.optionalFields("inBlockState", TypeReferences.BLOCK_STATE.in(schema)));
		...
		schema.register(
			...
			string -> DSL.optionalFields("DisplayState", TypeReferences.BLOCK_STATE.in(schema), "Items", DSL.list(TypeReferences.ITEM_STACK.in(schema)))
		);
		method_5232(schema, map, "minecraft:chicken");
		schema.register(map, "minecraft:commandblock_minecart", string -> DSL.optionalFields("DisplayState", TypeReferences.BLOCK_STATE.in(schema)));
		...
		schema.register(
			map, "minecraft:enderman", string -> DSL.optionalFields("carriedBlockState", TypeReferences.BLOCK_STATE.in(schema), Schema100.targetItems(schema))
		);
		...
		schema.register(
			...
			string -> DSL.optionalFields("BlockState", TypeReferences.BLOCK_STATE.in(schema), "TileEntityData", TypeReferences.BLOCK_ENTITY.in(schema))
		);
		...
		schema.register(map, "minecraft:furnace_minecart", string -> DSL.optionalFields("DisplayState", TypeReferences.BLOCK_STATE.in(schema)));
		...
		schema.register(map, "minecraft:minecart", string -> DSL.optionalFields("DisplayState", TypeReferences.BLOCK_STATE.in(schema)));
		...
		schema.register(map, "minecraft:potion", string -> DSL.optionalFields("Potion", TypeReferences.ITEM_STACK.in(schema)));
		...
		schema.register(
			...
			string -> DSL.optionalFields("DisplayState", TypeReferences.BLOCK_STATE.in(schema), TypeReferences.UNTAGGED_SPAWNER.in(schema))
		);
		schema.register(map, "minecraft:spectral_arrow", string -> DSL.optionalFields("inBlockState", TypeReferences.BLOCK_STATE.in(schema)));
		...
		schema.register(map, "minecraft:tnt_minecart", string -> DSL.optionalFields("DisplayState", TypeReferences.BLOCK_STATE.in(schema)));
	...
	public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema schema) {
		...
		schema.register(map, "minecraft:jukebox", string -> DSL.optionalFields("RecordItem", TypeReferences.ITEM_STACK.in(schema)));
		...
		schema.register(map, "minecraft:mob_spawner", string -> TypeReferences.UNTAGGED_SPAWNER.in(schema));
		schema.register(map, "minecraft:piston", string -> DSL.optionalFields("blockState", TypeReferences.BLOCK_STATE.in(schema)));
