		...
		if (optional.equals(Optional.of("customized"))) {
			...
			switch (bl6) {
				...
				case "buffet":
					...
					Dynamic<T> dynamic9 = (Dynamic<T>)optionalDynamic2.get("biome_source")
						.result()
					...
					if (dynamic9.get("type").asString().result().equals(Optional.of("minecraft:fixed"))) {
						String string = (String)dynamic9.get("options")
							.get("biomes")
							.asStream()
							.findFirst()
					...
					dynamic2 = method_28268(l, dynamic, dynamic6, dynamic10);
					break;
				default:
