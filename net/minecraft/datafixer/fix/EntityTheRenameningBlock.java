...
public class EntityTheRenameningBlock extends EntityRenameFix {
	public static final Map<String, String> ENTITIES = ImmutableMap.builder()
		...
		.build();
	public static final Map<String, String> BLOCKS = ImmutableMap.builder()
		...
		.build();
	public static final Map<String, String> ITEMS = ImmutableMap.builder()
		.putAll(BLOCKS)
