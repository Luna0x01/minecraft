...
public class ItemIdFix extends DataFix {
	private static final Int2ObjectMap<String> field_22341 = (Int2ObjectMap<String>)DataFixUtils.make(new Int2ObjectOpenHashMap(), int2ObjectOpenHashMap -> {
	...
	public static String method_21767(int i) {
		return (String)field_22341.get(i);
	}

	public TypeRewriteRule makeRule() {
		Type<Either<Integer, Pair<String, String>>> type = DSL.or(DSL.intType(), DSL.named(class_3402.field_16598.typeName(), DSL.namespacedString()));
		Type<Pair<String, String>> type2 = DSL.named(class_3402.field_16598.typeName(), DSL.namespacedString());
		OpticFinder<Either<Integer, Pair<String, String>>> opticFinder = DSL.fieldFinder("id", type);
		return this.fixTypeEverywhereTyped(
			"ItemIdFix",
			this.getInputSchema().getType(class_3402.field_16592),
			this.getOutputSchema().getType(class_3402.field_16592),
			typed -> typed.update(
					opticFinder, type2, either -> (Pair)either.map(integer -> Pair.of(class_3402.field_16598.typeName(), method_21767(integer)), pair -> pair)
				)
		);
	}
}
