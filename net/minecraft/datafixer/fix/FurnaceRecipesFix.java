...
public class FurnaceRecipesFix extends DataFix {
	...
	private <R> TypeRewriteRule updateBlockEntities(Type<R> type) {
		...
		return this.fixTypeEverywhereTyped(
			...
			type6,
			type7,
			typed -> typed.updateTyped(opticFinder, type3, typedx -> this.updateBlockEntityData(type, type2, typedx))
					.updateTyped(opticFinder2, type4, typedx -> this.updateBlockEntityData(type, type2, typedx))
					.updateTyped(opticFinder3, type5, typedx -> this.updateBlockEntityData(type, type2, typedx))
		);
	}
