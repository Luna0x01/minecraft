...
public class EntityRidingToPassengerFix extends DataFix {
	...
	public TypeRewriteRule makeRule() {
		...
		Type<?> type = schema.getTypeRaw(class_3402.field_16595);
		Type<?> type2 = schema2.getTypeRaw(class_3402.field_16595);
		Type<?> type3 = schema.getTypeRaw(class_3402.field_16596);
		return this.method_21741(schema, schema2, type, type2, type3);
	}

	private <OldEntityTree, NewEntityTree, Entity> TypeRewriteRule method_21741(
		...
		Type<Pair<String, Pair<Either<OldEntityTree, Unit>, Entity>>> type4 = DSL.named(
			class_3402.field_16595.typeName(), DSL.and(DSL.optional(DSL.field("Riding", type)), type3)
		);
		Type<Pair<String, Pair<Either<List<NewEntityTree>, Unit>, Entity>>> type5 = DSL.named(
			class_3402.field_16595.typeName(), DSL.and(DSL.optional(DSL.field("Passengers", DSL.list(type2))), type3)
		);
		Type<?> type6 = schema.getType(class_3402.field_16595);
		Type<?> type7 = schema2.getType(class_3402.field_16595);
		if (!Objects.equals(type6, type4)) {
			...
			Type<?> type8 = schema.getType(class_3402.field_16583);
			Type<?> type9 = schema2.getType(class_3402.field_16583);
				...
				this.fixTypeEverywhere(
					...
					dynamicOps -> pair -> {
							...
							while (true) {
								...
								optional = Optional.of(Pair.of(class_3402.field_16595.typeName(), Pair.of(either, ((Pair)pair2.getSecond()).getSecond())));
								...
								pair2 = (Pair<String, Pair<Either<OldEntityTree, Unit>, Entity>>)new Typed(type, dynamicOps, optional2.get())
