	...
	PLAY(0) {
		{
			...
			this.register(NetworkSide.CLIENTBOUND, ChunkMapS2CPacket.class);
			...
			this.register(NetworkSide.CLIENTBOUND, UpdateSignS2CPacket.class);
			...
			this.register(NetworkSide.CLIENTBOUND, UpdateEntityNbtS2CPacket.class);
