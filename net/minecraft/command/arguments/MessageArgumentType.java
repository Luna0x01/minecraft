...
public class MessageArgumentType implements ArgumentType<MessageArgumentType.MessageFormat> {
	...
	public static Text getMessage(CommandContext<ServerCommandSource> commandContext, String string) throws CommandSyntaxException {
		return ((MessageArgumentType.MessageFormat)commandContext.getArgument(string, MessageArgumentType.MessageFormat.class))
			.format((ServerCommandSource)commandContext.getSource(), ((ServerCommandSource)commandContext.getSource()).hasPermissionLevel(2));
	}
