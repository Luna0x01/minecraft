...
public class class_4520 extends class_3407 {
	public static final Map<String, String> field_22338 = ImmutableMap.builder()
		...
		.build();
	public static final Map<String, String> field_22339 = ImmutableMap.builder()
		...
		.build();
	public static final Map<String, String> field_22340 = ImmutableMap.builder()
		.putAll(field_22339)
	...
	public class_4520(Schema schema, boolean bl) {
	...
	protected String method_15257(String string) {
		...
		return (String)field_22338.getOrDefault(string, string);
	}
}
