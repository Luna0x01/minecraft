...
public class Scoreboard {
	...
	public void resetPlayerScore(String string, @Nullable ScoreboardObjective scoreboardObjective) {
		if (scoreboardObjective == null) {
			...
			Map<ScoreboardObjective, ScoreboardPlayerScore> map2 = (Map<ScoreboardObjective, ScoreboardPlayerScore>)this.playerObjectives.get(string);
			if (map2 != null) {
				ScoreboardPlayerScore scoreboardPlayerScore = (ScoreboardPlayerScore)map2.remove(scoreboardObjective);
				if (map2.size() < 1) {
					Map<ScoreboardObjective, ScoreboardPlayerScore> map3 = (Map<ScoreboardObjective, ScoreboardPlayerScore>)this.playerObjectives.remove(string);
					if (map3 != null) {
						this.updatePlayerScore(string);
					}
