...
public class class_3171 implements Criterion<class_3171.class_3173> {
	...
	@Override
	public void method_14973(AdvancementFile file, Criterion.class_3353<class_3171.class_3173> arg) {
	...
	@Override
	public void method_14974(AdvancementFile file, Criterion.class_3353<class_3171.class_3173> arg) {
		class_3171.class_3172 lv = (class_3171.class_3172)this.field_15620.get(file);
		if (lv != null) {
			lv.method_14146(arg);
			if (lv.method_14143()) {
	...
	public class_3171.class_3173 fromJson(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext) {
		EffectsJson effectsJson = EffectsJson.fromJson(jsonObject.get("effects"));
		return new class_3171.class_3173(effectsJson);
	}
	...
	static class class_3172 {
		...
		private final Set<Criterion.class_3353<class_3171.class_3173>> field_15622 = Sets.newHashSet();
		...
		public void method_14145(Criterion.class_3353<class_3171.class_3173> arg) {
			this.field_15622.add(arg);
		}

		public void method_14146(Criterion.class_3353<class_3171.class_3173> arg) {
			this.field_15622.remove(arg);
		}

		public void method_14144(ServerPlayerEntity serverPlayerEntity) {
			List<Criterion.class_3353<class_3171.class_3173>> list = null;

			for (Criterion.class_3353<class_3171.class_3173> lv : this.field_15622) {
				if (lv.method_14975().method_14147(serverPlayerEntity)) {
					if (list == null) {
			...
			if (list != null) {
				for (Criterion.class_3353<class_3171.class_3173> lv2 : list) {
	...
	public static class class_3173 extends AbstractCriterionInstance {
		private final EffectsJson field_15623;

		public class_3173(EffectsJson effectsJson) {
			super(class_3171.field_15619);
			this.field_15623 = effectsJson;
		}

		public boolean method_14147(ServerPlayerEntity serverPlayerEntity) {
			return this.field_15623.method_14340(serverPlayerEntity);
		}
	}
}
