...
public class LocationArrivalCriterion implements Criterion<LocationArrivalCriterion.Conditions> {
	...
	private final Map<PlayerAdvancementTracker, LocationArrivalCriterion.Handler> handlers = Maps.newHashMap();
	...
	static class Handler {
		...
		private final Set<Criterion.ConditionsContainer<LocationArrivalCriterion.Conditions>> conditions = Sets.newHashSet();
		...
		public void handle(ServerWorld serverWorld, double d, double e, double f) {
			...
			if (list != null) {
				for (Criterion.ConditionsContainer<LocationArrivalCriterion.Conditions> conditionsContainer2 : list) {
