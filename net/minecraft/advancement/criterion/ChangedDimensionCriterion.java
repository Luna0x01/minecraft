...
public class ChangedDimensionCriterion implements Criterion<ChangedDimensionCriterion.Conditions> {
	...
	private final Map<PlayerAdvancementTracker, ChangedDimensionCriterion.Handler> handlers = Maps.newHashMap();
	...
	static class Handler {
		...
		private final Set<Criterion.ConditionsContainer<ChangedDimensionCriterion.Conditions>> conditions = Sets.newHashSet();
		...
		public void handle(DimensionType dimensionType, DimensionType dimensionType2) {
			...
			if (list != null) {
				for (Criterion.ConditionsContainer<ChangedDimensionCriterion.Conditions> conditionsContainer2 : list) {
