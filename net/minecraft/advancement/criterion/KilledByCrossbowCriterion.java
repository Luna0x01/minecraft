...
public class KilledByCrossbowCriterion implements Criterion<KilledByCrossbowCriterion.Conditions> {
	...
	private final Map<PlayerAdvancementTracker, KilledByCrossbowCriterion.Handler> handlers = Maps.newHashMap();
	...
	static class Handler {
		...
		private final Set<Criterion.ConditionsContainer<KilledByCrossbowCriterion.Conditions>> conditions = Sets.newHashSet();
		...
		public void trigger(ServerPlayerEntity serverPlayerEntity, Collection<Entity> collection, int i) {
			...
			if (list != null) {
				for (Criterion.ConditionsContainer<KilledByCrossbowCriterion.Conditions> conditionsContainer2 : list) {
