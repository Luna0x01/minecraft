...
public class EnterBlockCriterion implements Criterion<EnterBlockCriterion.Conditions> {
	...
	private final Map<PlayerAdvancementTracker, EnterBlockCriterion.Handler> handlers = Maps.newHashMap();
	...
	static class Handler {
		...
		private final Set<Criterion.ConditionsContainer<EnterBlockCriterion.Conditions>> conditions = Sets.newHashSet();
		...
		public void handle(BlockState blockState) {
			...
			if (list != null) {
				for (Criterion.ConditionsContainer<EnterBlockCriterion.Conditions> conditionsContainer2 : list) {
