...
public class UsedEnderEyeCriterion implements Criterion<UsedEnderEyeCriterion.Conditions> {
	...
	private final Map<PlayerAdvancementTracker, UsedEnderEyeCriterion.Handler> handlers = Maps.newHashMap();
	...
	static class Handler {
		...
		private final Set<Criterion.ConditionsContainer<UsedEnderEyeCriterion.Conditions>> conditions = Sets.newHashSet();
		...
		public void handle(double d) {
			...
			if (list != null) {
				for (Criterion.ConditionsContainer<UsedEnderEyeCriterion.Conditions> conditionsContainer2 : list) {
