...
public class NetherTravelCriterion implements Criterion<NetherTravelCriterion.Conditions> {
	...
	private final Map<PlayerAdvancementTracker, NetherTravelCriterion.Handler> handlers = Maps.newHashMap();
	...
	static class Handler {
		...
		private final Set<Criterion.ConditionsContainer<NetherTravelCriterion.Conditions>> conditions = Sets.newHashSet();
		...
		public void handle(ServerWorld serverWorld, Vec3d vec3d, double d, double e, double f) {
			...
			if (list != null) {
				for (Criterion.ConditionsContainer<NetherTravelCriterion.Conditions> conditionsContainer2 : list) {
