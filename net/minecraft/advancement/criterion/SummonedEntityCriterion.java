...
public class SummonedEntityCriterion implements Criterion<SummonedEntityCriterion.Conditions> {
	...
	private final Map<PlayerAdvancementTracker, SummonedEntityCriterion.Handler> handlers = Maps.newHashMap();
	...
	static class Handler {
		...
		private final Set<Criterion.ConditionsContainer<SummonedEntityCriterion.Conditions>> conditions = Sets.newHashSet();
		...
		public void handle(ServerPlayerEntity serverPlayerEntity, Entity entity) {
			...
			if (list != null) {
				for (Criterion.ConditionsContainer<SummonedEntityCriterion.Conditions> conditionsContainer2 : list) {
