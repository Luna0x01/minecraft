...
public class LevitationCriterion implements Criterion<LevitationCriterion.Conditions> {
	...
	private final Map<PlayerAdvancementTracker, LevitationCriterion.Handler> handlers = Maps.newHashMap();
	...
	static class Handler {
		...
		private final Set<Criterion.ConditionsContainer<LevitationCriterion.Conditions>> conditions = Sets.newHashSet();
		...
		public void handle(ServerPlayerEntity serverPlayerEntity, Vec3d vec3d, int i) {
			...
			if (list != null) {
				for (Criterion.ConditionsContainer<LevitationCriterion.Conditions> conditionsContainer2 : list) {
