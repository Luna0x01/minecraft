...
public class ConstructBeaconCriterion implements Criterion<ConstructBeaconCriterion.Conditions> {
	...
	private final Map<PlayerAdvancementTracker, ConstructBeaconCriterion.Handler> handlers = Maps.newHashMap();
	...
	static class Handler {
		...
		private final Set<Criterion.ConditionsContainer<ConstructBeaconCriterion.Conditions>> conditions = Sets.newHashSet();
		...
		public void handle(BeaconBlockEntity beaconBlockEntity) {
			...
			if (list != null) {
				for (Criterion.ConditionsContainer<ConstructBeaconCriterion.Conditions> conditionsContainer2 : list) {
