...
public class ShotCrossbowCriterion implements Criterion<ShotCrossbowCriterion.Conditions> {
	...
	private final Map<PlayerAdvancementTracker, ShotCrossbowCriterion.Handler> handlers = Maps.newHashMap();
	...
	static class Handler {
		...
		private final Set<Criterion.ConditionsContainer<ShotCrossbowCriterion.Conditions>> conditions = Sets.newHashSet();
		...
		public void trigger(ItemStack itemStack) {
			...
			if (list != null) {
				for (Criterion.ConditionsContainer<ShotCrossbowCriterion.Conditions> conditionsContainer2 : list) {
					conditionsContainer2.apply(this.tracker);
				}
			}
		}
	}
