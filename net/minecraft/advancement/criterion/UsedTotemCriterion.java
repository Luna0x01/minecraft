...
public class UsedTotemCriterion implements Criterion<UsedTotemCriterion.Conditions> {
	...
	private final Map<PlayerAdvancementTracker, UsedTotemCriterion.Handler> handlers = Maps.newHashMap();
	...
	static class Handler {
		...
		private final Set<Criterion.ConditionsContainer<UsedTotemCriterion.Conditions>> conditions = Sets.newHashSet();
		...
		public void handle(ItemStack itemStack) {
			...
			if (list != null) {
				for (Criterion.ConditionsContainer<UsedTotemCriterion.Conditions> conditionsContainer2 : list) {
