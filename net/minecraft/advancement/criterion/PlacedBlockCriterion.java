...
public class PlacedBlockCriterion implements Criterion<PlacedBlockCriterion.Conditions> {
	...
	private final Map<PlayerAdvancementTracker, PlacedBlockCriterion.Handler> handlers = Maps.newHashMap();
	...
	static class Handler {
		...
		private final Set<Criterion.ConditionsContainer<PlacedBlockCriterion.Conditions>> conditions = Sets.newHashSet();
		...
		public void handle(BlockState blockState, BlockPos blockPos, ServerWorld serverWorld, ItemStack itemStack) {
			...
			if (list != null) {
				for (Criterion.ConditionsContainer<PlacedBlockCriterion.Conditions> conditionsContainer2 : list) {
