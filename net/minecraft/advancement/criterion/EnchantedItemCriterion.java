...
public class EnchantedItemCriterion implements Criterion<EnchantedItemCriterion.Conditions> {
	...
	private final Map<PlayerAdvancementTracker, EnchantedItemCriterion.Handler> handlers = Maps.newHashMap();
	...
	static class Handler {
		...
		private final Set<Criterion.ConditionsContainer<EnchantedItemCriterion.Conditions>> conditions = Sets.newHashSet();
		...
		public void handle(ItemStack itemStack, int i) {
			...
			if (list != null) {
				for (Criterion.ConditionsContainer<EnchantedItemCriterion.Conditions> conditionsContainer2 : list) {
