...
public class EffectsChangedCriterion implements Criterion<EffectsChangedCriterion.Conditions> {
	...
	private final Map<PlayerAdvancementTracker, EffectsChangedCriterion.Handler> handlers = Maps.newHashMap();
	...
	static class Handler {
		...
		private final Set<Criterion.ConditionsContainer<EffectsChangedCriterion.Conditions>> conditions = Sets.newHashSet();
		...
		public void handle(ServerPlayerEntity serverPlayerEntity) {
			...
			if (list != null) {
				for (Criterion.ConditionsContainer<EffectsChangedCriterion.Conditions> conditionsContainer2 : list) {
