...
public class TameAnimalCriterion implements Criterion<TameAnimalCriterion.Conditions> {
	...
	private final Map<PlayerAdvancementTracker, TameAnimalCriterion.Handler> handlers = Maps.newHashMap();
	...
	static class Handler {
		...
		private final Set<Criterion.ConditionsContainer<TameAnimalCriterion.Conditions>> Conditions = Sets.newHashSet();
		...
		public void handle(ServerPlayerEntity serverPlayerEntity, AnimalEntity animalEntity) {
			...
			if (list != null) {
				for (Criterion.ConditionsContainer<TameAnimalCriterion.Conditions> conditionsContainer2 : list) {
