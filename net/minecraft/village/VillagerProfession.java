...
public class VillagerProfession {
	...
	public static final VillagerProfession field_17056 = register(
		...
		ImmutableSet.of(Items.field_8861, Items.field_8317, Items.field_8309),
	...
	static VillagerProfession register(
		...
		return Registry.register(
			Registry.field_17167, new Identifier(string), new VillagerProfession(string, pointOfInterestType, immutableSet, immutableSet2, soundEvent)
		);
	}
}
