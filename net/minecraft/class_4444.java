...
public class class_4444 extends class_4445 {
	@Override
	protected ChunkBlockStateStorage method_21302(
		...
		chunkGenerator.method_17019(
			new class_4441(chunkBlockStateStorages, arg.method_17053() * 2 + 1, arg.method_17053() * 2 + 1, i, j, world), class_3801.class_3802.AIR
		);
		ChunkBlockStateStorage chunkBlockStateStorage = chunkBlockStateStorages[chunkBlockStateStorages.length / 2];
		chunkBlockStateStorage.method_16990(class_3786.CARVED);
