...
public class class_3400 extends DataFix {
	private static final Map<String, String> field_16580 = ImmutableMap.builder()
	...
	public class_3400(Schema schema, boolean bl) {
		super(schema, bl);
	}
	...
	protected TypeRewriteRule makeRule() {
		...
		if (!Objects.equals(type, this.getInputSchema().getType(class_3402.field_16603))) {
			...
			return this.fixTypeEverywhere("Recipes fix", type, dynamicOps -> pair -> pair.mapSecond(string -> (String)field_16580.getOrDefault(string, string)));
		}
	}
}
